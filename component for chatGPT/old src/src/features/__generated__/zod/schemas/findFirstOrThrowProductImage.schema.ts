...
export const ProductImageFindFirstOrThrowZodSchema = z.object({ select: ProductImageFindFirstOrThrowSelectSchema.optional(), include: ProductImageIncludeObjectSchema.optional(), orderBy: z.union([ProductImageOrderByWithRelationInputObjectSchema, ProductImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductImageWhereInputObjectSchema.optional(), cursor: ProductImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductImageScalarFieldEnumSchema, ProductImageScalarFieldEnumSchema.array()]).optional() }).strict();