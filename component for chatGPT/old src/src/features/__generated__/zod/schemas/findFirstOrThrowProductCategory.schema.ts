...
export const ProductCategoryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProductCategorySelect> = z.object({
...
export const ProductCategoryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    scope: z.boolean().optional(),
...
export const ProductCategoryFindFirstOrThrowSchema: z.ZodType<Prisma.ProductCategoryFindFirstOrThrowArgs> = z.object({ select: ProductCategoryFindFirstOrThrowSelectSchema.optional(), include: ProductCategoryIncludeObjectSchema.optional(), orderBy: z.union([ProductCategoryOrderByWithRelationInputObjectSchema, ProductCategoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductCategoryWhereInputObjectSchema.optional(), cursor: ProductCategoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductCategoryScalarFieldEnumSchema, ProductCategoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductCategoryFindFirstOrThrowArgs>;

export const ProductCategoryFindFirstOrThrowZodSchema = z.object({ select: ProductCategoryFindFirstOrThrowSelectSchema.optional(), include: ProductCategoryIncludeObjectSchema.optional(), orderBy: z.union([ProductCategoryOrderByWithRelationInputObjectSchema, ProductCategoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductCategoryWhereInputObjectSchema.optional(), cursor: ProductCategoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductCategoryScalarFieldEnumSchema, ProductCategoryScalarFieldEnumSchema.array()]).optional() }).strict();