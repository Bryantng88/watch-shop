...
export const WatchSpecUncheckedCreateNestedOneWithoutProductInputObjectSchema: z.ZodType<Prisma.WatchSpecUncheckedCreateNestedOneWithoutProductInput> = makeSchema() as unknown as z.ZodType<Prisma.WatchSpecUncheckedCreateNestedOneWithoutProductInput>;
export const WatchSpecUncheckedCreateNestedOneWithoutProductInputObjectZodSchema = makeSchema();
