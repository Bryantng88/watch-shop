...
export const MaintenanceRecordCreateNestedManyWithoutPaymentInputObjectSchema: z.ZodType<Prisma.MaintenanceRecordCreateNestedManyWithoutPaymentInput> = makeSchema() as unknown as z.ZodType<Prisma.MaintenanceRecordCreateNestedManyWithoutPaymentInput>;
export const MaintenanceRecordCreateNestedManyWithoutPaymentInputObjectZodSchema = makeSchema();
