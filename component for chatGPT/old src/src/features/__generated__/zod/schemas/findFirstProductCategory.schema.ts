...
export const ProductCategoryFindFirstSelectSchema: z.ZodType<Prisma.ProductCategorySelect> = z.object({
...
export const ProductCategoryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    scope: z.boolean().optional(),
