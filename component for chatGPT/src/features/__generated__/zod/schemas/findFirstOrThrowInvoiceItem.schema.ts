...
export const InvoiceItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.InvoiceItemSelect> = z.object({
...
export const InvoiceItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    invoiceId: z.boolean().optional(),
    productId: z.boolean().optional(),
    variantId: z.boolean().optional(),
...
export const InvoiceItemFindFirstOrThrowSchema: z.ZodType<Prisma.InvoiceItemFindFirstOrThrowArgs> = z.object({ select: InvoiceItemFindFirstOrThrowSelectSchema.optional(), include: InvoiceItemIncludeObjectSchema.optional(), orderBy: z.union([InvoiceItemOrderByWithRelationInputObjectSchema, InvoiceItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: InvoiceItemWhereInputObjectSchema.optional(), cursor: InvoiceItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InvoiceItemScalarFieldEnumSchema, InvoiceItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InvoiceItemFindFirstOrThrowArgs>;

export const InvoiceItemFindFirstOrThrowZodSchema = z.object({ select: InvoiceItemFindFirstOrThrowSelectSchema.optional(), include: InvoiceItemIncludeObjectSchema.optional(), orderBy: z.union([InvoiceItemOrderByWithRelationInputObjectSchema, InvoiceItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: InvoiceItemWhereInputObjectSchema.optional(), cursor: InvoiceItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InvoiceItemScalarFieldEnumSchema, InvoiceItemScalarFieldEnumSchema.array()]).optional() }).strict();