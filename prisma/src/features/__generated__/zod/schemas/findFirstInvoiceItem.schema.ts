...
export const InvoiceItemFindFirstSelectSchema: z.ZodType<Prisma.InvoiceItemSelect> = z.object({
...
export const InvoiceItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    invoiceId: z.boolean().optional(),
    productId: z.boolean().optional(),
    variantId: z.boolean().optional(),
