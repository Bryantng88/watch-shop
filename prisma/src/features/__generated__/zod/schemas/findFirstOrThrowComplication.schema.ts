...
export const ComplicationFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ComplicationSelect> = z.object({
...
export const ComplicationFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    watchSpecs: z.boolean().optional(),
    _count: z.boolean().optional()
...
export const ComplicationFindFirstOrThrowSchema: z.ZodType<Prisma.ComplicationFindFirstOrThrowArgs> = z.object({ select: ComplicationFindFirstOrThrowSelectSchema.optional(), include: ComplicationIncludeObjectSchema.optional(), orderBy: z.union([ComplicationOrderByWithRelationInputObjectSchema, ComplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: ComplicationWhereInputObjectSchema.optional(), cursor: ComplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ComplicationScalarFieldEnumSchema, ComplicationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ComplicationFindFirstOrThrowArgs>;

export const ComplicationFindFirstOrThrowZodSchema = z.object({ select: ComplicationFindFirstOrThrowSelectSchema.optional(), include: ComplicationIncludeObjectSchema.optional(), orderBy: z.union([ComplicationOrderByWithRelationInputObjectSchema, ComplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: ComplicationWhereInputObjectSchema.optional(), cursor: ComplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ComplicationScalarFieldEnumSchema, ComplicationScalarFieldEnumSchema.array()]).optional() }).strict();