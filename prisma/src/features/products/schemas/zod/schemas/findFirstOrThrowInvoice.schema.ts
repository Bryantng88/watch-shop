...
export const InvoiceFindFirstOrThrowSchema: z.ZodType<Prisma.InvoiceFindFirstOrThrowArgs> = z.object({ select: InvoiceFindFirstOrThrowSelectSchema.optional(), include: InvoiceIncludeObjectSchema.optional(), orderBy: z.union([InvoiceOrderByWithRelationInputObjectSchema, InvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: InvoiceWhereInputObjectSchema.optional(), cursor: InvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InvoiceScalarFieldEnumSchema, InvoiceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InvoiceFindFirstOrThrowArgs>;

export const InvoiceFindFirstOrThrowZodSchema = z.object({ select: InvoiceFindFirstOrThrowSelectSchema.optional(), include: InvoiceIncludeObjectSchema.optional(), orderBy: z.union([InvoiceOrderByWithRelationInputObjectSchema, InvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: InvoiceWhereInputObjectSchema.optional(), cursor: InvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InvoiceScalarFieldEnumSchema, InvoiceScalarFieldEnumSchema.array()]).optional() }).strict();