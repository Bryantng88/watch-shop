...
export const ServiceRequestUncheckedCreateNestedManyWithoutOrderItemInputObjectSchema: z.ZodType<Prisma.ServiceRequestUncheckedCreateNestedManyWithoutOrderItemInput> = makeSchema() as unknown as z.ZodType<Prisma.ServiceRequestUncheckedCreateNestedManyWithoutOrderItemInput>;
export const ServiceRequestUncheckedCreateNestedManyWithoutOrderItemInputObjectZodSchema = makeSchema();
