...
export const MarketSegmentUncheckedCreateNestedManyWithoutWatchSpecsInputObjectSchema: z.ZodType<Prisma.MarketSegmentUncheckedCreateNestedManyWithoutWatchSpecsInput> = makeSchema() as unknown as z.ZodType<Prisma.MarketSegmentUncheckedCreateNestedManyWithoutWatchSpecsInput>;
export const MarketSegmentUncheckedCreateNestedManyWithoutWatchSpecsInputObjectZodSchema = makeSchema();
