...
export const PaymentUncheckedCreateNestedManyWithoutInvoiceInputObjectSchema: z.ZodType<Prisma.PaymentUncheckedCreateNestedManyWithoutInvoiceInput> = makeSchema() as unknown as z.ZodType<Prisma.PaymentUncheckedCreateNestedManyWithoutInvoiceInput>;
export const PaymentUncheckedCreateNestedManyWithoutInvoiceInputObjectZodSchema = makeSchema();
