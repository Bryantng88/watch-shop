...
export const PaymentUpsertOneSchema: z.ZodType<Prisma.PaymentUpsertArgs> = z.object({ select: PaymentSelectObjectSchema.optional(),  where: PaymentWhereUniqueInputObjectSchema, create: z.union([ PaymentCreateInputObjectSchema, PaymentUncheckedCreateInputObjectSchema ]), update: z.union([ PaymentUpdateInputObjectSchema, PaymentUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.PaymentUpsertArgs>;

export const PaymentUpsertOneZodSchema = z.object({ select: PaymentSelectObjectSchema.optional(),  where: PaymentWhereUniqueInputObjectSchema, create: z.union([ PaymentCreateInputObjectSchema, PaymentUncheckedCreateInputObjectSchema ]), update: z.union([ PaymentUpdateInputObjectSchema, PaymentUncheckedUpdateInputObjectSchema ]) }).strict();