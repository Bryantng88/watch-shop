...
export const StorefrontHeroImageFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StorefrontHeroImageSelect> = z.object({
...
export const StorefrontHeroImageFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    storageKey: z.boolean().optional(),
    derivativeKey: z.boolean().optional(),
    originalFileName: z.boolean().optional(),
...
export const StorefrontHeroImageFindFirstOrThrowSchema: z.ZodType<Prisma.StorefrontHeroImageFindFirstOrThrowArgs> = z.object({ select: StorefrontHeroImageFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([StorefrontHeroImageOrderByWithRelationInputObjectSchema, StorefrontHeroImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: StorefrontHeroImageWhereInputObjectSchema.optional(), cursor: StorefrontHeroImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StorefrontHeroImageScalarFieldEnumSchema, StorefrontHeroImageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StorefrontHeroImageFindFirstOrThrowArgs>;

export const StorefrontHeroImageFindFirstOrThrowZodSchema = z.object({ select: StorefrontHeroImageFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([StorefrontHeroImageOrderByWithRelationInputObjectSchema, StorefrontHeroImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: StorefrontHeroImageWhereInputObjectSchema.optional(), cursor: StorefrontHeroImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StorefrontHeroImageScalarFieldEnumSchema, StorefrontHeroImageScalarFieldEnumSchema.array()]).optional() }).strict();