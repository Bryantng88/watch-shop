...
export const ProjectionRecordFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProjectionRecordSelect> = z.object({
...
export const ProjectionRecordFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    projectionKey: z.boolean().optional(),
    projectionVersion: z.boolean().optional(),
    rowKey: z.boolean().optional(),
...
export const ProjectionRecordFindFirstOrThrowSchema: z.ZodType<Prisma.ProjectionRecordFindFirstOrThrowArgs> = z.object({ select: ProjectionRecordFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([ProjectionRecordOrderByWithRelationInputObjectSchema, ProjectionRecordOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectionRecordWhereInputObjectSchema.optional(), cursor: ProjectionRecordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectionRecordScalarFieldEnumSchema, ProjectionRecordScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProjectionRecordFindFirstOrThrowArgs>;

export const ProjectionRecordFindFirstOrThrowZodSchema = z.object({ select: ProjectionRecordFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([ProjectionRecordOrderByWithRelationInputObjectSchema, ProjectionRecordOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectionRecordWhereInputObjectSchema.optional(), cursor: ProjectionRecordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectionRecordScalarFieldEnumSchema, ProjectionRecordScalarFieldEnumSchema.array()]).optional() }).strict();