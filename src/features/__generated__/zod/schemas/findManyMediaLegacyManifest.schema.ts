...
export const MediaLegacyManifestFindManySelectSchema: z.ZodType<Prisma.MediaLegacyManifestSelect> = z.object({
...
export const MediaLegacyManifestFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    legacyMediaAssetId: z.boolean().optional(),
    legacyKey: z.boolean().optional(),
    classification: z.boolean().optional(),
...
export const MediaLegacyManifestFindManySchema: z.ZodType<Prisma.MediaLegacyManifestFindManyArgs> = z.object({ select: MediaLegacyManifestFindManySelectSchema.optional(),  orderBy: z.union([MediaLegacyManifestOrderByWithRelationInputObjectSchema, MediaLegacyManifestOrderByWithRelationInputObjectSchema.array()]).optional(), where: MediaLegacyManifestWhereInputObjectSchema.optional(), cursor: MediaLegacyManifestWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MediaLegacyManifestScalarFieldEnumSchema, MediaLegacyManifestScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MediaLegacyManifestFindManyArgs>;

export const MediaLegacyManifestFindManyZodSchema = z.object({ select: MediaLegacyManifestFindManySelectSchema.optional(),  orderBy: z.union([MediaLegacyManifestOrderByWithRelationInputObjectSchema, MediaLegacyManifestOrderByWithRelationInputObjectSchema.array()]).optional(), where: MediaLegacyManifestWhereInputObjectSchema.optional(), cursor: MediaLegacyManifestWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MediaLegacyManifestScalarFieldEnumSchema, MediaLegacyManifestScalarFieldEnumSchema.array()]).optional() }).strict();