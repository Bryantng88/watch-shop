...
export const ClaspVariantSpecFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ClaspVariantSpecSelect> = z.object({
...
export const ClaspVariantSpecFindFirstOrThrowSelectZodSchema = z.object({
    variantId: z.boolean().optional(),
    claspType: z.boolean().optional(),
    widthMM: z.boolean().optional(),
    originType: z.boolean().optional(),
