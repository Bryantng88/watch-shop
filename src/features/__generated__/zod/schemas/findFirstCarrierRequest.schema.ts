...
export const CarrierRequestFindFirstSelectSchema: z.ZodType<Prisma.CarrierRequestSelect> = z.object({
...
export const CarrierRequestFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    shipmentId: z.boolean().optional(),
    carrierCode: z.boolean().optional(),
    environment: z.boolean().optional(),
