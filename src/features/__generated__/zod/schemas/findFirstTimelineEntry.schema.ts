...
export const TimelineEntryFindFirstSelectSchema: z.ZodType<Prisma.TimelineEntrySelect> = z.object({
...
export const TimelineEntryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    containerType: z.boolean().optional(),
    containerId: z.boolean().optional(),
    sourceType: z.boolean().optional(),
...
export const TimelineEntryFindFirstSchema: z.ZodType<Prisma.TimelineEntryFindFirstArgs> = z.object({ select: TimelineEntryFindFirstSelectSchema.optional(),  orderBy: z.union([TimelineEntryOrderByWithRelationInputObjectSchema, TimelineEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: TimelineEntryWhereInputObjectSchema.optional(), cursor: TimelineEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TimelineEntryScalarFieldEnumSchema, TimelineEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TimelineEntryFindFirstArgs>;

export const TimelineEntryFindFirstZodSchema = z.object({ select: TimelineEntryFindFirstSelectSchema.optional(),  orderBy: z.union([TimelineEntryOrderByWithRelationInputObjectSchema, TimelineEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: TimelineEntryWhereInputObjectSchema.optional(), cursor: TimelineEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TimelineEntryScalarFieldEnumSchema, TimelineEntryScalarFieldEnumSchema.array()]).optional() }).strict();