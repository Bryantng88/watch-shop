...
export const TaskItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TaskItemSelect> = z.object({
...
export const TaskItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskId: z.boolean().optional(),
    title: z.boolean().optional(),
    note: z.boolean().optional(),
...
export const TaskItemFindFirstOrThrowSchema: z.ZodType<Prisma.TaskItemFindFirstOrThrowArgs> = z.object({ select: TaskItemFindFirstOrThrowSelectSchema.optional(), include: TaskItemIncludeObjectSchema.optional(), orderBy: z.union([TaskItemOrderByWithRelationInputObjectSchema, TaskItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemWhereInputObjectSchema.optional(), cursor: TaskItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemScalarFieldEnumSchema, TaskItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaskItemFindFirstOrThrowArgs>;

export const TaskItemFindFirstOrThrowZodSchema = z.object({ select: TaskItemFindFirstOrThrowSelectSchema.optional(), include: TaskItemIncludeObjectSchema.optional(), orderBy: z.union([TaskItemOrderByWithRelationInputObjectSchema, TaskItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemWhereInputObjectSchema.optional(), cursor: TaskItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemScalarFieldEnumSchema, TaskItemScalarFieldEnumSchema.array()]).optional() }).strict();