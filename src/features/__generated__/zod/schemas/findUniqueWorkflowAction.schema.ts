...
export const WorkflowActionFindUniqueSchema: z.ZodType<Prisma.WorkflowActionFindUniqueArgs> = z.object({ select: WorkflowActionSelectObjectSchema.optional(), include: WorkflowActionIncludeObjectSchema.optional(), where: WorkflowActionWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.WorkflowActionFindUniqueArgs>;

export const WorkflowActionFindUniqueZodSchema = z.object({ select: WorkflowActionSelectObjectSchema.optional(), include: WorkflowActionIncludeObjectSchema.optional(), where: WorkflowActionWhereUniqueInputObjectSchema }).strict();