...
export const WorkflowTemplateFindFirstSelectSchema: z.ZodType<Prisma.WorkflowTemplateSelect> = z.object({
...
export const WorkflowTemplateFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const WorkflowTemplateFindFirstSchema: z.ZodType<Prisma.WorkflowTemplateFindFirstArgs> = z.object({ select: WorkflowTemplateFindFirstSelectSchema.optional(), include: WorkflowTemplateIncludeObjectSchema.optional(), orderBy: z.union([WorkflowTemplateOrderByWithRelationInputObjectSchema, WorkflowTemplateOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowTemplateWhereInputObjectSchema.optional(), cursor: WorkflowTemplateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowTemplateScalarFieldEnumSchema, WorkflowTemplateScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkflowTemplateFindFirstArgs>;

export const WorkflowTemplateFindFirstZodSchema = z.object({ select: WorkflowTemplateFindFirstSelectSchema.optional(), include: WorkflowTemplateIncludeObjectSchema.optional(), orderBy: z.union([WorkflowTemplateOrderByWithRelationInputObjectSchema, WorkflowTemplateOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowTemplateWhereInputObjectSchema.optional(), cursor: WorkflowTemplateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowTemplateScalarFieldEnumSchema, WorkflowTemplateScalarFieldEnumSchema.array()]).optional() }).strict();