...
export const NotificationChannelDeliveryFindManySelectSchema: z.ZodType<Prisma.NotificationChannelDeliverySelect> = z.object({
...
export const NotificationChannelDeliveryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    dispatchId: z.boolean().optional(),
    channel: z.boolean().optional(),
    recipientGroupKey: z.boolean().optional(),
