...
export const MediaAssetFindManySelectSchema: z.ZodType<Prisma.MediaAssetSelect> = z.object({
...
export const MediaAssetFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    key: z.boolean().optional(),
    parentPrefix: z.boolean().optional(),
    fileName: z.boolean().optional(),
...
export const MediaAssetFindManySchema: z.ZodType<Prisma.MediaAssetFindManyArgs> = z.object({ select: MediaAssetFindManySelectSchema.optional(),  orderBy: z.union([MediaAssetOrderByWithRelationInputObjectSchema, MediaAssetOrderByWithRelationInputObjectSchema.array()]).optional(), where: MediaAssetWhereInputObjectSchema.optional(), cursor: MediaAssetWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MediaAssetScalarFieldEnumSchema, MediaAssetScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MediaAssetFindManyArgs>;

export const MediaAssetFindManyZodSchema = z.object({ select: MediaAssetFindManySelectSchema.optional(),  orderBy: z.union([MediaAssetOrderByWithRelationInputObjectSchema, MediaAssetOrderByWithRelationInputObjectSchema.array()]).optional(), where: MediaAssetWhereInputObjectSchema.optional(), cursor: MediaAssetWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MediaAssetScalarFieldEnumSchema, MediaAssetScalarFieldEnumSchema.array()]).optional() }).strict();