...
export const PurchaseRequestActivityFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PurchaseRequestActivitySelect> = z.object({
...
export const PurchaseRequestActivityFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    purchaseRequestId: z.boolean().optional(),
    type: z.boolean().optional(),
    note: z.boolean().optional(),
...
export const PurchaseRequestActivityFindFirstOrThrowSchema: z.ZodType<Prisma.PurchaseRequestActivityFindFirstOrThrowArgs> = z.object({ select: PurchaseRequestActivityFindFirstOrThrowSelectSchema.optional(), include: PurchaseRequestActivityIncludeObjectSchema.optional(), orderBy: z.union([PurchaseRequestActivityOrderByWithRelationInputObjectSchema, PurchaseRequestActivityOrderByWithRelationInputObjectSchema.array()]).optional(), where: PurchaseRequestActivityWhereInputObjectSchema.optional(), cursor: PurchaseRequestActivityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PurchaseRequestActivityScalarFieldEnumSchema, PurchaseRequestActivityScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PurchaseRequestActivityFindFirstOrThrowArgs>;

export const PurchaseRequestActivityFindFirstOrThrowZodSchema = z.object({ select: PurchaseRequestActivityFindFirstOrThrowSelectSchema.optional(), include: PurchaseRequestActivityIncludeObjectSchema.optional(), orderBy: z.union([PurchaseRequestActivityOrderByWithRelationInputObjectSchema, PurchaseRequestActivityOrderByWithRelationInputObjectSchema.array()]).optional(), where: PurchaseRequestActivityWhereInputObjectSchema.optional(), cursor: PurchaseRequestActivityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PurchaseRequestActivityScalarFieldEnumSchema, PurchaseRequestActivityScalarFieldEnumSchema.array()]).optional() }).strict();