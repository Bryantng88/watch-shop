...
export const TaskItemActivityReplyFindManySelectSchema: z.ZodType<Prisma.TaskItemActivityReplySelect> = z.object({
...
export const TaskItemActivityReplyFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    activityId: z.boolean().optional(),
    actorUserId: z.boolean().optional(),
    body: z.boolean().optional(),
...
export const TaskItemActivityReplyFindManySchema: z.ZodType<Prisma.TaskItemActivityReplyFindManyArgs> = z.object({ select: TaskItemActivityReplyFindManySelectSchema.optional(), include: TaskItemActivityReplyIncludeObjectSchema.optional(), orderBy: z.union([TaskItemActivityReplyOrderByWithRelationInputObjectSchema, TaskItemActivityReplyOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemActivityReplyWhereInputObjectSchema.optional(), cursor: TaskItemActivityReplyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemActivityReplyScalarFieldEnumSchema, TaskItemActivityReplyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaskItemActivityReplyFindManyArgs>;

export const TaskItemActivityReplyFindManyZodSchema = z.object({ select: TaskItemActivityReplyFindManySelectSchema.optional(), include: TaskItemActivityReplyIncludeObjectSchema.optional(), orderBy: z.union([TaskItemActivityReplyOrderByWithRelationInputObjectSchema, TaskItemActivityReplyOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemActivityReplyWhereInputObjectSchema.optional(), cursor: TaskItemActivityReplyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemActivityReplyScalarFieldEnumSchema, TaskItemActivityReplyScalarFieldEnumSchema.array()]).optional() }).strict();