...
export const TaskTypeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TaskTypeSelect> = z.object({
...
export const TaskTypeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
