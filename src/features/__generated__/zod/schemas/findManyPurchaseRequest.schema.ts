...
export const PurchaseRequestFindManySelectSchema: z.ZodType<Prisma.PurchaseRequestSelect> = z.object({
...
export const PurchaseRequestFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    reference: z.boolean().optional(),
    status: z.boolean().optional(),
    outcome: z.boolean().optional(),
