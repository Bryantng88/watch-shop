...
export const WorkflowEventLogFindFirstSelectSchema: z.ZodType<Prisma.WorkflowEventLogSelect> = z.object({
...
export const WorkflowEventLogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    eventKey: z.boolean().optional(),
    targetType: z.boolean().optional(),
    targetId: z.boolean().optional(),
...
export const WorkflowEventLogFindFirstSchema: z.ZodType<Prisma.WorkflowEventLogFindFirstArgs> = z.object({ select: WorkflowEventLogFindFirstSelectSchema.optional(),  orderBy: z.union([WorkflowEventLogOrderByWithRelationInputObjectSchema, WorkflowEventLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowEventLogWhereInputObjectSchema.optional(), cursor: WorkflowEventLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowEventLogScalarFieldEnumSchema, WorkflowEventLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkflowEventLogFindFirstArgs>;

export const WorkflowEventLogFindFirstZodSchema = z.object({ select: WorkflowEventLogFindFirstSelectSchema.optional(),  orderBy: z.union([WorkflowEventLogOrderByWithRelationInputObjectSchema, WorkflowEventLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowEventLogWhereInputObjectSchema.optional(), cursor: WorkflowEventLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowEventLogScalarFieldEnumSchema, WorkflowEventLogScalarFieldEnumSchema.array()]).optional() }).strict();