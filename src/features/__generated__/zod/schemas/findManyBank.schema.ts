...
export const BankFindManySelectSchema: z.ZodType<Prisma.BankSelect> = z.object({
...
export const BankFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    created_at: z.boolean().optional(),
    bankName: z.boolean().optional(),
    Vendor: z.boolean().optional(),
