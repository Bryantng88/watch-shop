...
export const ProjectionRecordFindFirstSelectSchema: z.ZodType<Prisma.ProjectionRecordSelect> = z.object({
...
export const ProjectionRecordFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    projectionKey: z.boolean().optional(),
    projectionVersion: z.boolean().optional(),
    rowKey: z.boolean().optional(),
...
export const ProjectionRecordFindFirstSchema: z.ZodType<Prisma.ProjectionRecordFindFirstArgs> = z.object({ select: ProjectionRecordFindFirstSelectSchema.optional(),  orderBy: z.union([ProjectionRecordOrderByWithRelationInputObjectSchema, ProjectionRecordOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectionRecordWhereInputObjectSchema.optional(), cursor: ProjectionRecordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectionRecordScalarFieldEnumSchema, ProjectionRecordScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProjectionRecordFindFirstArgs>;

export const ProjectionRecordFindFirstZodSchema = z.object({ select: ProjectionRecordFindFirstSelectSchema.optional(),  orderBy: z.union([ProjectionRecordOrderByWithRelationInputObjectSchema, ProjectionRecordOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectionRecordWhereInputObjectSchema.optional(), cursor: ProjectionRecordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectionRecordScalarFieldEnumSchema, ProjectionRecordScalarFieldEnumSchema.array()]).optional() }).strict();