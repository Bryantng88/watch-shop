...
export const ShipmentPackageFindFirstSelectSchema: z.ZodType<Prisma.ShipmentPackageSelect> = z.object({
...
export const ShipmentPackageFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    shipmentId: z.boolean().optional(),
    weightGram: z.boolean().optional(),
    lengthCm: z.boolean().optional(),
...
export const ShipmentPackageFindFirstSchema: z.ZodType<Prisma.ShipmentPackageFindFirstArgs> = z.object({ select: ShipmentPackageFindFirstSelectSchema.optional(), include: ShipmentPackageIncludeObjectSchema.optional(), orderBy: z.union([ShipmentPackageOrderByWithRelationInputObjectSchema, ShipmentPackageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ShipmentPackageWhereInputObjectSchema.optional(), cursor: ShipmentPackageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ShipmentPackageScalarFieldEnumSchema, ShipmentPackageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ShipmentPackageFindFirstArgs>;

export const ShipmentPackageFindFirstZodSchema = z.object({ select: ShipmentPackageFindFirstSelectSchema.optional(), include: ShipmentPackageIncludeObjectSchema.optional(), orderBy: z.union([ShipmentPackageOrderByWithRelationInputObjectSchema, ShipmentPackageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ShipmentPackageWhereInputObjectSchema.optional(), cursor: ShipmentPackageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ShipmentPackageScalarFieldEnumSchema, ShipmentPackageScalarFieldEnumSchema.array()]).optional() }).strict();