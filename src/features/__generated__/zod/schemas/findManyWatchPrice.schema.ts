...
export const WatchPriceFindManySelectSchema: z.ZodType<Prisma.WatchPriceSelect> = z.object({
...
export const WatchPriceFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    watchId: z.boolean().optional(),
    costPrice: z.boolean().optional(),
    serviceCost: z.boolean().optional(),
...
export const WatchPriceFindManySchema: z.ZodType<Prisma.WatchPriceFindManyArgs> = z.object({ select: WatchPriceFindManySelectSchema.optional(), include: WatchPriceIncludeObjectSchema.optional(), orderBy: z.union([WatchPriceOrderByWithRelationInputObjectSchema, WatchPriceOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchPriceWhereInputObjectSchema.optional(), cursor: WatchPriceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchPriceScalarFieldEnumSchema, WatchPriceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WatchPriceFindManyArgs>;

export const WatchPriceFindManyZodSchema = z.object({ select: WatchPriceFindManySelectSchema.optional(), include: WatchPriceIncludeObjectSchema.optional(), orderBy: z.union([WatchPriceOrderByWithRelationInputObjectSchema, WatchPriceOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchPriceWhereInputObjectSchema.optional(), cursor: WatchPriceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchPriceScalarFieldEnumSchema, WatchPriceScalarFieldEnumSchema.array()]).optional() }).strict();