...
export const WatchStrapInstallationFindManySelectSchema: z.ZodType<Prisma.WatchStrapInstallationSelect> = z.object({
...
export const WatchStrapInstallationFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    watchId: z.boolean().optional(),
    strapVariantId: z.boolean().optional(),
    ownershipMode: z.boolean().optional(),
...
export const WatchStrapInstallationFindManySchema: z.ZodType<Prisma.WatchStrapInstallationFindManyArgs> = z.object({ select: WatchStrapInstallationFindManySelectSchema.optional(), include: WatchStrapInstallationIncludeObjectSchema.optional(), orderBy: z.union([WatchStrapInstallationOrderByWithRelationInputObjectSchema, WatchStrapInstallationOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchStrapInstallationWhereInputObjectSchema.optional(), cursor: WatchStrapInstallationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchStrapInstallationScalarFieldEnumSchema, WatchStrapInstallationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WatchStrapInstallationFindManyArgs>;

export const WatchStrapInstallationFindManyZodSchema = z.object({ select: WatchStrapInstallationFindManySelectSchema.optional(), include: WatchStrapInstallationIncludeObjectSchema.optional(), orderBy: z.union([WatchStrapInstallationOrderByWithRelationInputObjectSchema, WatchStrapInstallationOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchStrapInstallationWhereInputObjectSchema.optional(), cursor: WatchStrapInstallationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchStrapInstallationScalarFieldEnumSchema, WatchStrapInstallationScalarFieldEnumSchema.array()]).optional() }).strict();