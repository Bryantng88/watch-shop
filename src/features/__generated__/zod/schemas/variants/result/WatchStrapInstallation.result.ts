...
// prettier-ignore
export const WatchStrapInstallationResultSchema = z.object({
    id: z.string(),
    watchId: z.string(),
...
export type WatchStrapInstallationResultType = z.infer<typeof WatchStrapInstallationResultSchema>;
