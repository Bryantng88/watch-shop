...
// prettier-ignore
export const PurchaseRequestActivityResultSchema = z.object({
    id: z.string(),
...
export type PurchaseRequestActivityResultType = z.infer<typeof PurchaseRequestActivityResultSchema>;
