...
// prettier-ignore
export const StrapInventoryMovementResultSchema = z.object({
    id: z.string(),
...
export type StrapInventoryMovementResultType = z.infer<typeof StrapInventoryMovementResultSchema>;
