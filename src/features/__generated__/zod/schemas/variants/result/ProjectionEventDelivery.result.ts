...
// prettier-ignore
export const ProjectionEventDeliveryResultSchema = z.object({
    id: z.string(),
...
export type ProjectionEventDeliveryResultType = z.infer<typeof ProjectionEventDeliveryResultSchema>;
