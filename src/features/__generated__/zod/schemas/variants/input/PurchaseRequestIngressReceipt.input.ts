...
// prettier-ignore
export const PurchaseRequestIngressReceiptInputSchema = z.object({
    id: z.string(),
    requestKey: z.string(),
...
export type PurchaseRequestIngressReceiptInputType = z.infer<typeof PurchaseRequestIngressReceiptInputSchema>;
