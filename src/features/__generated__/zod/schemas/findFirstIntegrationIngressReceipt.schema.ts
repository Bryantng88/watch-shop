...
export const IntegrationIngressReceiptFindFirstSelectSchema: z.ZodType<Prisma.IntegrationIngressReceiptSelect> = z.object({
...
export const IntegrationIngressReceiptFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    channel: z.boolean().optional(),
    keyId: z.boolean().optional(),
    nonce: z.boolean().optional(),
...
export const IntegrationIngressReceiptFindFirstSchema: z.ZodType<Prisma.IntegrationIngressReceiptFindFirstArgs> = z.object({ select: IntegrationIngressReceiptFindFirstSelectSchema.optional(),  orderBy: z.union([IntegrationIngressReceiptOrderByWithRelationInputObjectSchema, IntegrationIngressReceiptOrderByWithRelationInputObjectSchema.array()]).optional(), where: IntegrationIngressReceiptWhereInputObjectSchema.optional(), cursor: IntegrationIngressReceiptWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([IntegrationIngressReceiptScalarFieldEnumSchema, IntegrationIngressReceiptScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.IntegrationIngressReceiptFindFirstArgs>;

export const IntegrationIngressReceiptFindFirstZodSchema = z.object({ select: IntegrationIngressReceiptFindFirstSelectSchema.optional(),  orderBy: z.union([IntegrationIngressReceiptOrderByWithRelationInputObjectSchema, IntegrationIngressReceiptOrderByWithRelationInputObjectSchema.array()]).optional(), where: IntegrationIngressReceiptWhereInputObjectSchema.optional(), cursor: IntegrationIngressReceiptWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([IntegrationIngressReceiptScalarFieldEnumSchema, IntegrationIngressReceiptScalarFieldEnumSchema.array()]).optional() }).strict();