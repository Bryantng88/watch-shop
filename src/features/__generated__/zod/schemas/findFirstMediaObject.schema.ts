...
export const MediaObjectFindFirstSelectSchema: z.ZodType<Prisma.MediaObjectSelect> = z.object({
...
export const MediaObjectFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    bucket: z.boolean().optional(),
    storageKey: z.boolean().optional(),
    originalFileName: z.boolean().optional(),
...
export const MediaObjectFindFirstSchema: z.ZodType<Prisma.MediaObjectFindFirstArgs> = z.object({ select: MediaObjectFindFirstSelectSchema.optional(), include: MediaObjectIncludeObjectSchema.optional(), orderBy: z.union([MediaObjectOrderByWithRelationInputObjectSchema, MediaObjectOrderByWithRelationInputObjectSchema.array()]).optional(), where: MediaObjectWhereInputObjectSchema.optional(), cursor: MediaObjectWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MediaObjectScalarFieldEnumSchema, MediaObjectScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MediaObjectFindFirstArgs>;

export const MediaObjectFindFirstZodSchema = z.object({ select: MediaObjectFindFirstSelectSchema.optional(), include: MediaObjectIncludeObjectSchema.optional(), orderBy: z.union([MediaObjectOrderByWithRelationInputObjectSchema, MediaObjectOrderByWithRelationInputObjectSchema.array()]).optional(), where: MediaObjectWhereInputObjectSchema.optional(), cursor: MediaObjectWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MediaObjectScalarFieldEnumSchema, MediaObjectScalarFieldEnumSchema.array()]).optional() }).strict();