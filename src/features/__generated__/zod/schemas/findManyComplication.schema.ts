...
export const ComplicationFindManySelectSchema: z.ZodType<Prisma.ComplicationSelect> = z.object({
...
export const ComplicationFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    watchSpecs: z.boolean().optional(),
    _count: z.boolean().optional()
...
export const ComplicationFindManySchema: z.ZodType<Prisma.ComplicationFindManyArgs> = z.object({ select: ComplicationFindManySelectSchema.optional(), include: ComplicationIncludeObjectSchema.optional(), orderBy: z.union([ComplicationOrderByWithRelationInputObjectSchema, ComplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: ComplicationWhereInputObjectSchema.optional(), cursor: ComplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ComplicationScalarFieldEnumSchema, ComplicationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ComplicationFindManyArgs>;

export const ComplicationFindManyZodSchema = z.object({ select: ComplicationFindManySelectSchema.optional(), include: ComplicationIncludeObjectSchema.optional(), orderBy: z.union([ComplicationOrderByWithRelationInputObjectSchema, ComplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: ComplicationWhereInputObjectSchema.optional(), cursor: ComplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ComplicationScalarFieldEnumSchema, ComplicationScalarFieldEnumSchema.array()]).optional() }).strict();