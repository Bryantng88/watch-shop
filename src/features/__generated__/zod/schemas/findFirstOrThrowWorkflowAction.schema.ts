...
export const WorkflowActionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.WorkflowActionSelect> = z.object({
...
export const WorkflowActionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    workflowId: z.boolean().optional(),
    actionType: z.boolean().optional(),
    sortOrder: z.boolean().optional(),
...
export const WorkflowActionFindFirstOrThrowSchema: z.ZodType<Prisma.WorkflowActionFindFirstOrThrowArgs> = z.object({ select: WorkflowActionFindFirstOrThrowSelectSchema.optional(), include: WorkflowActionIncludeObjectSchema.optional(), orderBy: z.union([WorkflowActionOrderByWithRelationInputObjectSchema, WorkflowActionOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowActionWhereInputObjectSchema.optional(), cursor: WorkflowActionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowActionScalarFieldEnumSchema, WorkflowActionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkflowActionFindFirstOrThrowArgs>;

export const WorkflowActionFindFirstOrThrowZodSchema = z.object({ select: WorkflowActionFindFirstOrThrowSelectSchema.optional(), include: WorkflowActionIncludeObjectSchema.optional(), orderBy: z.union([WorkflowActionOrderByWithRelationInputObjectSchema, WorkflowActionOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowActionWhereInputObjectSchema.optional(), cursor: WorkflowActionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowActionScalarFieldEnumSchema, WorkflowActionScalarFieldEnumSchema.array()]).optional() }).strict();