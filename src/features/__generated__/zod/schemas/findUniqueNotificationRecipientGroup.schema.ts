...
export const NotificationRecipientGroupFindUniqueSchema: z.ZodType<Prisma.NotificationRecipientGroupFindUniqueArgs> = z.object({ select: NotificationRecipientGroupSelectObjectSchema.optional(),  where: NotificationRecipientGroupWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.NotificationRecipientGroupFindUniqueArgs>;

export const NotificationRecipientGroupFindUniqueZodSchema = z.object({ select: NotificationRecipientGroupSelectObjectSchema.optional(),  where: NotificationRecipientGroupWhereUniqueInputObjectSchema }).strict();