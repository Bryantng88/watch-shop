...
export const WatchSpecV2FindManySelectSchema: z.ZodType<Prisma.WatchSpecV2Select> = z.object({
...
export const WatchSpecV2FindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    watchId: z.boolean().optional(),
    brand: z.boolean().optional(),
    model: z.boolean().optional(),
...
export const WatchSpecV2FindManySchema: z.ZodType<Prisma.WatchSpecV2FindManyArgs> = z.object({ select: WatchSpecV2FindManySelectSchema.optional(), include: WatchSpecV2IncludeObjectSchema.optional(), orderBy: z.union([WatchSpecV2OrderByWithRelationInputObjectSchema, WatchSpecV2OrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchSpecV2WhereInputObjectSchema.optional(), cursor: WatchSpecV2WhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchSpecV2ScalarFieldEnumSchema, WatchSpecV2ScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WatchSpecV2FindManyArgs>;

export const WatchSpecV2FindManyZodSchema = z.object({ select: WatchSpecV2FindManySelectSchema.optional(), include: WatchSpecV2IncludeObjectSchema.optional(), orderBy: z.union([WatchSpecV2OrderByWithRelationInputObjectSchema, WatchSpecV2OrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchSpecV2WhereInputObjectSchema.optional(), cursor: WatchSpecV2WhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchSpecV2ScalarFieldEnumSchema, WatchSpecV2ScalarFieldEnumSchema.array()]).optional() }).strict();