...
export const CarrierChargeFindManySelectSchema: z.ZodType<Prisma.CarrierChargeSelect> = z.object({
...
export const CarrierChargeFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    shipmentId: z.boolean().optional(),
    kind: z.boolean().optional(),
    currency: z.boolean().optional(),
...
export const CarrierChargeFindManySchema: z.ZodType<Prisma.CarrierChargeFindManyArgs> = z.object({ select: CarrierChargeFindManySelectSchema.optional(), include: CarrierChargeIncludeObjectSchema.optional(), orderBy: z.union([CarrierChargeOrderByWithRelationInputObjectSchema, CarrierChargeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarrierChargeWhereInputObjectSchema.optional(), cursor: CarrierChargeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarrierChargeScalarFieldEnumSchema, CarrierChargeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CarrierChargeFindManyArgs>;

export const CarrierChargeFindManyZodSchema = z.object({ select: CarrierChargeFindManySelectSchema.optional(), include: CarrierChargeIncludeObjectSchema.optional(), orderBy: z.union([CarrierChargeOrderByWithRelationInputObjectSchema, CarrierChargeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarrierChargeWhereInputObjectSchema.optional(), cursor: CarrierChargeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarrierChargeScalarFieldEnumSchema, CarrierChargeScalarFieldEnumSchema.array()]).optional() }).strict();