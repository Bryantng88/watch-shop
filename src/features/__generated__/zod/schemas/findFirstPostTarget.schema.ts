...
export const PostTargetFindFirstSelectSchema: z.ZodType<Prisma.PostTargetSelect> = z.object({
...
export const PostTargetFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    platform: z.boolean().optional(),
    isActive: z.boolean().optional(),
