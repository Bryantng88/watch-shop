...
export const AcquisitionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AcquisitionSelect> = z.object({
    ...
    sourceOrder: z.boolean().optional(),
...
export const AcquisitionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    vendorId: z.boolean().optional(),
    customerId: z.boolean().optional(),
    sourceOrderId: z.boolean().optional(),
...
export const AcquisitionFindFirstOrThrowSchema: z.ZodType<Prisma.AcquisitionFindFirstOrThrowArgs> = z.object({ select: AcquisitionFindFirstOrThrowSelectSchema.optional(), include: AcquisitionIncludeObjectSchema.optional(), orderBy: z.union([AcquisitionOrderByWithRelationInputObjectSchema, AcquisitionOrderByWithRelationInputObjectSchema.array()]).optional(), where: AcquisitionWhereInputObjectSchema.optional(), cursor: AcquisitionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AcquisitionScalarFieldEnumSchema, AcquisitionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AcquisitionFindFirstOrThrowArgs>;

export const AcquisitionFindFirstOrThrowZodSchema = z.object({ select: AcquisitionFindFirstOrThrowSelectSchema.optional(), include: AcquisitionIncludeObjectSchema.optional(), orderBy: z.union([AcquisitionOrderByWithRelationInputObjectSchema, AcquisitionOrderByWithRelationInputObjectSchema.array()]).optional(), where: AcquisitionWhereInputObjectSchema.optional(), cursor: AcquisitionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AcquisitionScalarFieldEnumSchema, AcquisitionScalarFieldEnumSchema.array()]).optional() }).strict();