...
export const TaskChecklistItemFindManySelectSchema: z.ZodType<Prisma.TaskChecklistItemSelect> = z.object({
...
export const TaskChecklistItemFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskId: z.boolean().optional(),
    title: z.boolean().optional(),
    note: z.boolean().optional(),
...
export const TaskChecklistItemFindManySchema: z.ZodType<Prisma.TaskChecklistItemFindManyArgs> = z.object({ select: TaskChecklistItemFindManySelectSchema.optional(), include: TaskChecklistItemIncludeObjectSchema.optional(), orderBy: z.union([TaskChecklistItemOrderByWithRelationInputObjectSchema, TaskChecklistItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskChecklistItemWhereInputObjectSchema.optional(), cursor: TaskChecklistItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskChecklistItemScalarFieldEnumSchema, TaskChecklistItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaskChecklistItemFindManyArgs>;

export const TaskChecklistItemFindManyZodSchema = z.object({ select: TaskChecklistItemFindManySelectSchema.optional(), include: TaskChecklistItemIncludeObjectSchema.optional(), orderBy: z.union([TaskChecklistItemOrderByWithRelationInputObjectSchema, TaskChecklistItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskChecklistItemWhereInputObjectSchema.optional(), cursor: TaskChecklistItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskChecklistItemScalarFieldEnumSchema, TaskChecklistItemScalarFieldEnumSchema.array()]).optional() }).strict();