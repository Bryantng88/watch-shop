...
export const PurchaseRequestItemFindFirstSelectSchema: z.ZodType<Prisma.PurchaseRequestItemSelect> = z.object({
...
export const PurchaseRequestItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    purchaseRequestId: z.boolean().optional(),
    productId: z.boolean().optional(),
    titleSnapshot: z.boolean().optional(),
...
export const PurchaseRequestItemFindFirstSchema: z.ZodType<Prisma.PurchaseRequestItemFindFirstArgs> = z.object({ select: PurchaseRequestItemFindFirstSelectSchema.optional(), include: PurchaseRequestItemIncludeObjectSchema.optional(), orderBy: z.union([PurchaseRequestItemOrderByWithRelationInputObjectSchema, PurchaseRequestItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: PurchaseRequestItemWhereInputObjectSchema.optional(), cursor: PurchaseRequestItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PurchaseRequestItemScalarFieldEnumSchema, PurchaseRequestItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PurchaseRequestItemFindFirstArgs>;

export const PurchaseRequestItemFindFirstZodSchema = z.object({ select: PurchaseRequestItemFindFirstSelectSchema.optional(), include: PurchaseRequestItemIncludeObjectSchema.optional(), orderBy: z.union([PurchaseRequestItemOrderByWithRelationInputObjectSchema, PurchaseRequestItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: PurchaseRequestItemWhereInputObjectSchema.optional(), cursor: PurchaseRequestItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PurchaseRequestItemScalarFieldEnumSchema, PurchaseRequestItemScalarFieldEnumSchema.array()]).optional() }).strict();