...
export const WorkCaseActivityFindManySelectSchema: z.ZodType<Prisma.WorkCaseActivitySelect> = z.object({
...
export const WorkCaseActivityFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    workCaseId: z.boolean().optional(),
    actorId: z.boolean().optional(),
    action: z.boolean().optional(),
...
export const WorkCaseActivityFindManySchema: z.ZodType<Prisma.WorkCaseActivityFindManyArgs> = z.object({ select: WorkCaseActivityFindManySelectSchema.optional(), include: WorkCaseActivityIncludeObjectSchema.optional(), orderBy: z.union([WorkCaseActivityOrderByWithRelationInputObjectSchema, WorkCaseActivityOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkCaseActivityWhereInputObjectSchema.optional(), cursor: WorkCaseActivityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkCaseActivityScalarFieldEnumSchema, WorkCaseActivityScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkCaseActivityFindManyArgs>;

export const WorkCaseActivityFindManyZodSchema = z.object({ select: WorkCaseActivityFindManySelectSchema.optional(), include: WorkCaseActivityIncludeObjectSchema.optional(), orderBy: z.union([WorkCaseActivityOrderByWithRelationInputObjectSchema, WorkCaseActivityOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkCaseActivityWhereInputObjectSchema.optional(), cursor: WorkCaseActivityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkCaseActivityScalarFieldEnumSchema, WorkCaseActivityScalarFieldEnumSchema.array()]).optional() }).strict();