...
export const WatchPriceFindFirstSelectSchema: z.ZodType<Prisma.WatchPriceSelect> = z.object({
...
export const WatchPriceFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    watchId: z.boolean().optional(),
    costPrice: z.boolean().optional(),
    serviceCost: z.boolean().optional(),
...
export const WatchPriceFindFirstSchema: z.ZodType<Prisma.WatchPriceFindFirstArgs> = z.object({ select: WatchPriceFindFirstSelectSchema.optional(), include: WatchPriceIncludeObjectSchema.optional(), orderBy: z.union([WatchPriceOrderByWithRelationInputObjectSchema, WatchPriceOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchPriceWhereInputObjectSchema.optional(), cursor: WatchPriceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchPriceScalarFieldEnumSchema, WatchPriceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WatchPriceFindFirstArgs>;

export const WatchPriceFindFirstZodSchema = z.object({ select: WatchPriceFindFirstSelectSchema.optional(), include: WatchPriceIncludeObjectSchema.optional(), orderBy: z.union([WatchPriceOrderByWithRelationInputObjectSchema, WatchPriceOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchPriceWhereInputObjectSchema.optional(), cursor: WatchPriceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchPriceScalarFieldEnumSchema, WatchPriceScalarFieldEnumSchema.array()]).optional() }).strict();