...
export const CarrierWebhookDeliveryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CarrierWebhookDeliverySelect> = z.object({
...
export const CarrierWebhookDeliveryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    carrierCode: z.boolean().optional(),
    environment: z.boolean().optional(),
    externalEventId: z.boolean().optional(),
...
export const CarrierWebhookDeliveryFindFirstOrThrowSchema: z.ZodType<Prisma.CarrierWebhookDeliveryFindFirstOrThrowArgs> = z.object({ select: CarrierWebhookDeliveryFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([CarrierWebhookDeliveryOrderByWithRelationInputObjectSchema, CarrierWebhookDeliveryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarrierWebhookDeliveryWhereInputObjectSchema.optional(), cursor: CarrierWebhookDeliveryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarrierWebhookDeliveryScalarFieldEnumSchema, CarrierWebhookDeliveryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CarrierWebhookDeliveryFindFirstOrThrowArgs>;

export const CarrierWebhookDeliveryFindFirstOrThrowZodSchema = z.object({ select: CarrierWebhookDeliveryFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([CarrierWebhookDeliveryOrderByWithRelationInputObjectSchema, CarrierWebhookDeliveryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarrierWebhookDeliveryWhereInputObjectSchema.optional(), cursor: CarrierWebhookDeliveryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarrierWebhookDeliveryScalarFieldEnumSchema, CarrierWebhookDeliveryScalarFieldEnumSchema.array()]).optional() }).strict();