...
export const ProductPostTargetFindUniqueOrThrowSchema: z.ZodType<Prisma.ProductPostTargetFindUniqueOrThrowArgs> = z.object({ select: ProductPostTargetSelectObjectSchema.optional(), include: ProductPostTargetIncludeObjectSchema.optional(), where: ProductPostTargetWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ProductPostTargetFindUniqueOrThrowArgs>;

export const ProductPostTargetFindUniqueOrThrowZodSchema = z.object({ select: ProductPostTargetSelectObjectSchema.optional(), include: ProductPostTargetIncludeObjectSchema.optional(), where: ProductPostTargetWhereUniqueInputObjectSchema }).strict();