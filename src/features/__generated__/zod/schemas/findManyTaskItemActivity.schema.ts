...
export const TaskItemActivityFindManySelectSchema: z.ZodType<Prisma.TaskItemActivitySelect> = z.object({
...
export const TaskItemActivityFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskItemId: z.boolean().optional(),
    sourceType: z.boolean().optional(),
    sourceId: z.boolean().optional(),
...
export const TaskItemActivityFindManySchema: z.ZodType<Prisma.TaskItemActivityFindManyArgs> = z.object({ select: TaskItemActivityFindManySelectSchema.optional(), include: TaskItemActivityIncludeObjectSchema.optional(), orderBy: z.union([TaskItemActivityOrderByWithRelationInputObjectSchema, TaskItemActivityOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemActivityWhereInputObjectSchema.optional(), cursor: TaskItemActivityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemActivityScalarFieldEnumSchema, TaskItemActivityScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaskItemActivityFindManyArgs>;

export const TaskItemActivityFindManyZodSchema = z.object({ select: TaskItemActivityFindManySelectSchema.optional(), include: TaskItemActivityIncludeObjectSchema.optional(), orderBy: z.union([TaskItemActivityOrderByWithRelationInputObjectSchema, TaskItemActivityOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemActivityWhereInputObjectSchema.optional(), cursor: TaskItemActivityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemActivityScalarFieldEnumSchema, TaskItemActivityScalarFieldEnumSchema.array()]).optional() }).strict();