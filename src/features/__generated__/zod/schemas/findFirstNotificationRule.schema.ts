...
export const NotificationRuleFindFirstSelectSchema: z.ZodType<Prisma.NotificationRuleSelect> = z.object({
...
export const NotificationRuleFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    eventKey: z.boolean().optional(),
    enabled: z.boolean().optional(),
