...
export const WatchSpecV2FindFirstSelectSchema: z.ZodType<Prisma.WatchSpecV2Select> = z.object({
    ...
    strapSetType: z.boolean().optional(),
    strapComponentSource: z.boolean().optional(),
...
export const WatchSpecV2FindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    watchId: z.boolean().optional(),
    brand: z.boolean().optional(),
    model: z.boolean().optional(),
...
export const WatchSpecV2FindFirstSchema: z.ZodType<Prisma.WatchSpecV2FindFirstArgs> = z.object({ select: WatchSpecV2FindFirstSelectSchema.optional(), include: WatchSpecV2IncludeObjectSchema.optional(), orderBy: z.union([WatchSpecV2OrderByWithRelationInputObjectSchema, WatchSpecV2OrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchSpecV2WhereInputObjectSchema.optional(), cursor: WatchSpecV2WhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchSpecV2ScalarFieldEnumSchema, WatchSpecV2ScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WatchSpecV2FindFirstArgs>;

export const WatchSpecV2FindFirstZodSchema = z.object({ select: WatchSpecV2FindFirstSelectSchema.optional(), include: WatchSpecV2IncludeObjectSchema.optional(), orderBy: z.union([WatchSpecV2OrderByWithRelationInputObjectSchema, WatchSpecV2OrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchSpecV2WhereInputObjectSchema.optional(), cursor: WatchSpecV2WhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchSpecV2ScalarFieldEnumSchema, WatchSpecV2ScalarFieldEnumSchema.array()]).optional() }).strict();