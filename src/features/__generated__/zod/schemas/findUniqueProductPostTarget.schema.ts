...
export const ProductPostTargetFindUniqueSchema: z.ZodType<Prisma.ProductPostTargetFindUniqueArgs> = z.object({ select: ProductPostTargetSelectObjectSchema.optional(), include: ProductPostTargetIncludeObjectSchema.optional(), where: ProductPostTargetWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ProductPostTargetFindUniqueArgs>;

export const ProductPostTargetFindUniqueZodSchema = z.object({ select: ProductPostTargetSelectObjectSchema.optional(), include: ProductPostTargetIncludeObjectSchema.optional(), where: ProductPostTargetWhereUniqueInputObjectSchema }).strict();