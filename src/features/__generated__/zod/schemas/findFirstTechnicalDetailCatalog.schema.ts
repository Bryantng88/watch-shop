...
export const TechnicalDetailCatalogFindFirstSelectSchema: z.ZodType<Prisma.TechnicalDetailCatalogSelect> = z.object({
...
export const TechnicalDetailCatalogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    area: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const TechnicalDetailCatalogFindFirstSchema: z.ZodType<Prisma.TechnicalDetailCatalogFindFirstArgs> = z.object({ select: TechnicalDetailCatalogFindFirstSelectSchema.optional(), include: TechnicalDetailCatalogIncludeObjectSchema.optional(), orderBy: z.union([TechnicalDetailCatalogOrderByWithRelationInputObjectSchema, TechnicalDetailCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: TechnicalDetailCatalogWhereInputObjectSchema.optional(), cursor: TechnicalDetailCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalDetailCatalogScalarFieldEnumSchema, TechnicalDetailCatalogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TechnicalDetailCatalogFindFirstArgs>;

export const TechnicalDetailCatalogFindFirstZodSchema = z.object({ select: TechnicalDetailCatalogFindFirstSelectSchema.optional(), include: TechnicalDetailCatalogIncludeObjectSchema.optional(), orderBy: z.union([TechnicalDetailCatalogOrderByWithRelationInputObjectSchema, TechnicalDetailCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: TechnicalDetailCatalogWhereInputObjectSchema.optional(), cursor: TechnicalDetailCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalDetailCatalogScalarFieldEnumSchema, TechnicalDetailCatalogScalarFieldEnumSchema.array()]).optional() }).strict();