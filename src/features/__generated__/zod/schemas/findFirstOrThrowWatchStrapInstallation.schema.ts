...
export const WatchStrapInstallationFindFirstOrThrowSelectSchema: z.ZodType<Prisma.WatchStrapInstallationSelect> = z.object({
...
export const WatchStrapInstallationFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    watchId: z.boolean().optional(),
    strapVariantId: z.boolean().optional(),
    ownershipMode: z.boolean().optional(),
...
export const WatchStrapInstallationFindFirstOrThrowSchema: z.ZodType<Prisma.WatchStrapInstallationFindFirstOrThrowArgs> = z.object({ select: WatchStrapInstallationFindFirstOrThrowSelectSchema.optional(), include: WatchStrapInstallationIncludeObjectSchema.optional(), orderBy: z.union([WatchStrapInstallationOrderByWithRelationInputObjectSchema, WatchStrapInstallationOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchStrapInstallationWhereInputObjectSchema.optional(), cursor: WatchStrapInstallationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchStrapInstallationScalarFieldEnumSchema, WatchStrapInstallationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WatchStrapInstallationFindFirstOrThrowArgs>;

export const WatchStrapInstallationFindFirstOrThrowZodSchema = z.object({ select: WatchStrapInstallationFindFirstOrThrowSelectSchema.optional(), include: WatchStrapInstallationIncludeObjectSchema.optional(), orderBy: z.union([WatchStrapInstallationOrderByWithRelationInputObjectSchema, WatchStrapInstallationOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchStrapInstallationWhereInputObjectSchema.optional(), cursor: WatchStrapInstallationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchStrapInstallationScalarFieldEnumSchema, WatchStrapInstallationScalarFieldEnumSchema.array()]).optional() }).strict();