...
export const WorkflowTemplateFindFirstOrThrowSelectSchema: z.ZodType<Prisma.WorkflowTemplateSelect> = z.object({
...
export const WorkflowTemplateFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const WorkflowTemplateFindFirstOrThrowSchema: z.ZodType<Prisma.WorkflowTemplateFindFirstOrThrowArgs> = z.object({ select: WorkflowTemplateFindFirstOrThrowSelectSchema.optional(), include: WorkflowTemplateIncludeObjectSchema.optional(), orderBy: z.union([WorkflowTemplateOrderByWithRelationInputObjectSchema, WorkflowTemplateOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowTemplateWhereInputObjectSchema.optional(), cursor: WorkflowTemplateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowTemplateScalarFieldEnumSchema, WorkflowTemplateScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkflowTemplateFindFirstOrThrowArgs>;

export const WorkflowTemplateFindFirstOrThrowZodSchema = z.object({ select: WorkflowTemplateFindFirstOrThrowSelectSchema.optional(), include: WorkflowTemplateIncludeObjectSchema.optional(), orderBy: z.union([WorkflowTemplateOrderByWithRelationInputObjectSchema, WorkflowTemplateOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowTemplateWhereInputObjectSchema.optional(), cursor: WorkflowTemplateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowTemplateScalarFieldEnumSchema, WorkflowTemplateScalarFieldEnumSchema.array()]).optional() }).strict();