...
export const WorkflowConditionFindManySelectSchema: z.ZodType<Prisma.WorkflowConditionSelect> = z.object({
...
export const WorkflowConditionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    workflowId: z.boolean().optional(),
    eventKey: z.boolean().optional(),
    targetType: z.boolean().optional(),
