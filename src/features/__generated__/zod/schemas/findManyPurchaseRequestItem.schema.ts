...
export const PurchaseRequestItemFindManySelectSchema: z.ZodType<Prisma.PurchaseRequestItemSelect> = z.object({
...
export const PurchaseRequestItemFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    purchaseRequestId: z.boolean().optional(),
    productId: z.boolean().optional(),
    titleSnapshot: z.boolean().optional(),
