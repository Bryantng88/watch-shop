...
export const WorkflowActionFindManySelectSchema: z.ZodType<Prisma.WorkflowActionSelect> = z.object({
...
export const WorkflowActionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    workflowId: z.boolean().optional(),
    actionType: z.boolean().optional(),
    sortOrder: z.boolean().optional(),
