...
export const TaskItemChecklistFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TaskItemChecklistSelect> = z.object({
...
export const TaskItemChecklistFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskItemId: z.boolean().optional(),
    title: z.boolean().optional(),
    note: z.boolean().optional(),
...
export const TaskItemChecklistFindFirstOrThrowSchema: z.ZodType<Prisma.TaskItemChecklistFindFirstOrThrowArgs> = z.object({ select: TaskItemChecklistFindFirstOrThrowSelectSchema.optional(), include: TaskItemChecklistIncludeObjectSchema.optional(), orderBy: z.union([TaskItemChecklistOrderByWithRelationInputObjectSchema, TaskItemChecklistOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemChecklistWhereInputObjectSchema.optional(), cursor: TaskItemChecklistWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemChecklistScalarFieldEnumSchema, TaskItemChecklistScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaskItemChecklistFindFirstOrThrowArgs>;

export const TaskItemChecklistFindFirstOrThrowZodSchema = z.object({ select: TaskItemChecklistFindFirstOrThrowSelectSchema.optional(), include: TaskItemChecklistIncludeObjectSchema.optional(), orderBy: z.union([TaskItemChecklistOrderByWithRelationInputObjectSchema, TaskItemChecklistOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemChecklistWhereInputObjectSchema.optional(), cursor: TaskItemChecklistWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemChecklistScalarFieldEnumSchema, TaskItemChecklistScalarFieldEnumSchema.array()]).optional() }).strict();