...
export const TaskItemFindFirstSelectSchema: z.ZodType<Prisma.TaskItemSelect> = z.object({
...
export const TaskItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskId: z.boolean().optional(),
    title: z.boolean().optional(),
    note: z.boolean().optional(),
...
export const TaskItemFindFirstSchema: z.ZodType<Prisma.TaskItemFindFirstArgs> = z.object({ select: TaskItemFindFirstSelectSchema.optional(), include: TaskItemIncludeObjectSchema.optional(), orderBy: z.union([TaskItemOrderByWithRelationInputObjectSchema, TaskItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemWhereInputObjectSchema.optional(), cursor: TaskItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemScalarFieldEnumSchema, TaskItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaskItemFindFirstArgs>;

export const TaskItemFindFirstZodSchema = z.object({ select: TaskItemFindFirstSelectSchema.optional(), include: TaskItemIncludeObjectSchema.optional(), orderBy: z.union([TaskItemOrderByWithRelationInputObjectSchema, TaskItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemWhereInputObjectSchema.optional(), cursor: TaskItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemScalarFieldEnumSchema, TaskItemScalarFieldEnumSchema.array()]).optional() }).strict();