...
export const NotificationDispatchFindFirstOrThrowSelectSchema: z.ZodType<Prisma.NotificationDispatchSelect> = z.object({
...
export const NotificationDispatchFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    businessEventLogId: z.boolean().optional(),
    ruleId: z.boolean().optional(),
    eventKey: z.boolean().optional(),
...
export const NotificationDispatchFindFirstOrThrowSchema: z.ZodType<Prisma.NotificationDispatchFindFirstOrThrowArgs> = z.object({ select: NotificationDispatchFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([NotificationDispatchOrderByWithRelationInputObjectSchema, NotificationDispatchOrderByWithRelationInputObjectSchema.array()]).optional(), where: NotificationDispatchWhereInputObjectSchema.optional(), cursor: NotificationDispatchWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([NotificationDispatchScalarFieldEnumSchema, NotificationDispatchScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.NotificationDispatchFindFirstOrThrowArgs>;

export const NotificationDispatchFindFirstOrThrowZodSchema = z.object({ select: NotificationDispatchFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([NotificationDispatchOrderByWithRelationInputObjectSchema, NotificationDispatchOrderByWithRelationInputObjectSchema.array()]).optional(), where: NotificationDispatchWhereInputObjectSchema.optional(), cursor: NotificationDispatchWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([NotificationDispatchScalarFieldEnumSchema, NotificationDispatchScalarFieldEnumSchema.array()]).optional() }).strict();