...
const makeSchema = () => z.object({
  ...
  publicRequestKey: z.boolean().optional(),
  publicRequestHash: z.boolean().optional(),
  publicRequestChannel: z.boolean().optional(),
  publicExternalId: z.boolean().optional(),
  publicFingerprintHash: z.boolean().optional(),
  ...
  tradeInAcquisitions: z.union([z.boolean(), z.lazy(() => AcquisitionFindManySchema)]).optional(),
