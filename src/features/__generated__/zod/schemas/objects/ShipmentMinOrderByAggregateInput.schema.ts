...
const makeSchema = () => z.object({
  ...
  carrierEnvironment: SortOrderSchema.optional(),
  externalOrderCode: SortOrderSchema.optional(),
  carrierStatus: SortOrderSchema.optional(),
  carrierStatusText: SortOrderSchema.optional(),
  carrierSyncedAt: SortOrderSchema.optional(),
  carrierCreatedAt: SortOrderSchema.optional(),
  estimatedDeliveryAt: SortOrderSchema.optional(),
