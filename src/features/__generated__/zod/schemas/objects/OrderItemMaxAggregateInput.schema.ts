...
const makeSchema = () => z.object({
  ...
  previousSaleStage: z.literal(true).optional(),
  previousServiceStage: z.literal(true).optional(),
  previousStockStage: z.literal(true).optional(),
  previousProductStatus: z.literal(true).optional()
}).strict();
