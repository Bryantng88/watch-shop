...
const makeSchema = () => z.object({
  ...
  technical_issue_id: z.string().optional().nullable(),
  maintenanceRecord: z.lazy(() => MaintenanceRecordUncheckedCreateNestedManyWithoutPaymentInputObjectSchema).optional()
}).strict();
export const PaymentUncheckedCreateWithoutTaskInputObjectSchema: z.ZodType<Prisma.PaymentUncheckedCreateWithoutTaskInput> = makeSchema() as unknown as z.ZodType<Prisma.PaymentUncheckedCreateWithoutTaskInput>;
export const PaymentUncheckedCreateWithoutTaskInputObjectZodSchema = makeSchema();
