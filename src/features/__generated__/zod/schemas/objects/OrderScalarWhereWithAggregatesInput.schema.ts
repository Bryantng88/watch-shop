...
const orderscalarwherewithaggregatesinputSchema = z.object({
  ...
  shippingAmount: z.union([z.lazy(() => DecimalNullableWithAggregatesFilterObjectSchema), z.number()]).optional().nullable(),
  ...
  depositPaymentMethod: z.union([z.lazy(() => EnumPaymentMethodNullableWithAggregatesFilterObjectSchema), PaymentMethodSchema]).optional().nullable(),
