...
import { MediaBindingUncheckedUpdateManyWithoutMediaObjectNestedInputObjectSchema as MediaBindingUncheckedUpdateManyWithoutMediaObjectNestedInputObjectSchema } from './MediaBindingUncheckedUpdateManyWithoutMediaObjectNestedInput.schema';
import { MediaOperationUncheckedUpdateManyWithoutMediaObjectNestedInputObjectSchema as MediaOperationUncheckedUpdateManyWithoutMediaObjectNestedInputObjectSchema } from './MediaOperationUncheckedUpdateManyWithoutMediaObjectNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  bindings: z.lazy(() => MediaBindingUncheckedUpdateManyWithoutMediaObjectNestedInputObjectSchema).optional(),
  operations: z.lazy(() => MediaOperationUncheckedUpdateManyWithoutMediaObjectNestedInputObjectSchema).optional()
}).strict();
export const MediaObjectUncheckedUpdateInputObjectSchema: z.ZodType<Prisma.MediaObjectUncheckedUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.MediaObjectUncheckedUpdateInput>;
export const MediaObjectUncheckedUpdateInputObjectZodSchema = makeSchema();
