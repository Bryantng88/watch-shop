...
import { WatchMediaListRelationFilterObjectSchema as WatchMediaListRelationFilterObjectSchema } from './WatchMediaListRelationFilter.schema';
...
const watchwhereinputSchema = z.object({
  ...
  attachedStrapId: z.union([z.lazy(() => StringNullableFilterObjectSchema), z.string()]).optional().nullable(),
  ...
  watchMedia: z.lazy(() => WatchMediaListRelationFilterObjectSchema).optional(),
