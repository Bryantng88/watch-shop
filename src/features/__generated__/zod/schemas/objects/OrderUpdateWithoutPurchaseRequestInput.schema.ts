...
import { AcquisitionUpdateManyWithoutSourceOrderNestedInputObjectSchema as AcquisitionUpdateManyWithoutSourceOrderNestedInputObjectSchema } from './AcquisitionUpdateManyWithoutSourceOrderNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  shippingAmount: z.union([z.number(), z.lazy(() => NullableDecimalFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  ...
  depositPaymentMethod: z.union([PaymentMethodSchema, z.lazy(() => NullableEnumPaymentMethodFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  ...
  tradeInAcquisitions: z.lazy(() => AcquisitionUpdateManyWithoutSourceOrderNestedInputObjectSchema).optional()
}).strict();
export const OrderUpdateWithoutPurchaseRequestInputObjectSchema: z.ZodType<Prisma.OrderUpdateWithoutPurchaseRequestInput> = makeSchema() as unknown as z.ZodType<Prisma.OrderUpdateWithoutPurchaseRequestInput>;
export const OrderUpdateWithoutPurchaseRequestInputObjectZodSchema = makeSchema();
