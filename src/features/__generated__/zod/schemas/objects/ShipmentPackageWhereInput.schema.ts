...
const shipmentpackagewhereinputSchema = z.object({
  AND: z.union([z.lazy(() => ShipmentPackageWhereInputObjectSchema), z.lazy(() => ShipmentPackageWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => ShipmentPackageWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => ShipmentPackageWhereInputObjectSchema), z.lazy(() => ShipmentPackageWhereInputObjectSchema).array()]).optional(),
...
export const ShipmentPackageWhereInputObjectSchema: z.ZodType<Prisma.ShipmentPackageWhereInput> = shipmentpackagewhereinputSchema as unknown as z.ZodType<Prisma.ShipmentPackageWhereInput>;
export const ShipmentPackageWhereInputObjectZodSchema = shipmentpackagewhereinputSchema;
