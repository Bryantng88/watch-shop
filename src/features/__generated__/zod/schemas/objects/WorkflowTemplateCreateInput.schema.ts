...
const makeSchema = () => z.object({
  ...
  conditions: z.lazy(() => WorkflowConditionCreateNestedManyWithoutWorkflowInputObjectSchema),
  actions: z.lazy(() => WorkflowActionCreateNestedManyWithoutWorkflowInputObjectSchema),
  executions: z.lazy(() => WorkflowExecutionCreateNestedManyWithoutWorkflowInputObjectSchema),
  tags: z.lazy(() => AppTagCreateNestedManyWithoutWorkflowTemplateInputObjectSchema)
}).strict();
export const WorkflowTemplateCreateInputObjectSchema: z.ZodType<Prisma.WorkflowTemplateCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.WorkflowTemplateCreateInput>;
export const WorkflowTemplateCreateInputObjectZodSchema = makeSchema();
