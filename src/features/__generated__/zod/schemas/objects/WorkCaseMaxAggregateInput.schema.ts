...
export const WorkCaseMaxAggregateInputObjectSchema: z.ZodType<Prisma.WorkCaseMaxAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.WorkCaseMaxAggregateInputType>;
export const WorkCaseMaxAggregateInputObjectZodSchema = makeSchema();
