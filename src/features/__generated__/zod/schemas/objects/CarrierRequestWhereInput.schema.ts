...
const carrierrequestwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => CarrierRequestWhereInputObjectSchema), z.lazy(() => CarrierRequestWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => CarrierRequestWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => CarrierRequestWhereInputObjectSchema), z.lazy(() => CarrierRequestWhereInputObjectSchema).array()]).optional(),
...
export const CarrierRequestWhereInputObjectSchema: z.ZodType<Prisma.CarrierRequestWhereInput> = carrierrequestwhereinputSchema as unknown as z.ZodType<Prisma.CarrierRequestWhereInput>;
export const CarrierRequestWhereInputObjectZodSchema = carrierrequestwhereinputSchema;
