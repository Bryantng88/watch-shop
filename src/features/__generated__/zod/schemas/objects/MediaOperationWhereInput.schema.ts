...
import { MediaObjectNullableScalarRelationFilterObjectSchema as MediaObjectNullableScalarRelationFilterObjectSchema } from './MediaObjectNullableScalarRelationFilter.schema';
import { MediaObjectWhereInputObjectSchema as MediaObjectWhereInputObjectSchema } from './MediaObjectWhereInput.schema'

const mediaoperationwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => MediaOperationWhereInputObjectSchema), z.lazy(() => MediaOperationWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => MediaOperationWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => MediaOperationWhereInputObjectSchema), z.lazy(() => MediaOperationWhereInputObjectSchema).array()]).optional(),
  ...
  mediaObject: z.union([z.lazy(() => MediaObjectNullableScalarRelationFilterObjectSchema), z.lazy(() => MediaObjectWhereInputObjectSchema)]).optional()
}).strict();
export const MediaOperationWhereInputObjectSchema: z.ZodType<Prisma.MediaOperationWhereInput> = mediaoperationwhereinputSchema as unknown as z.ZodType<Prisma.MediaOperationWhereInput>;
export const MediaOperationWhereInputObjectZodSchema = mediaoperationwhereinputSchema;
