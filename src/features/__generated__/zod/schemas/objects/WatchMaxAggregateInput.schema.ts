...
export const WatchMaxAggregateInputObjectSchema: z.ZodType<Prisma.WatchMaxAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.WatchMaxAggregateInputType>;
export const WatchMaxAggregateInputObjectZodSchema = makeSchema();
