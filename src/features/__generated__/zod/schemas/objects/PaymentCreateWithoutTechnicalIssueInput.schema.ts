...
const makeSchema = () => z.object({
  ...
  maintenanceRecord: z.lazy(() => MaintenanceRecordCreateNestedManyWithoutPaymentInputObjectSchema).optional(),
  task: z.lazy(() => TaskCreateNestedManyWithoutPaymentInputObjectSchema).optional()
}).strict();
export const PaymentCreateWithoutTechnicalIssueInputObjectSchema: z.ZodType<Prisma.PaymentCreateWithoutTechnicalIssueInput> = makeSchema() as unknown as z.ZodType<Prisma.PaymentCreateWithoutTechnicalIssueInput>;
export const PaymentCreateWithoutTechnicalIssueInputObjectZodSchema = makeSchema();
