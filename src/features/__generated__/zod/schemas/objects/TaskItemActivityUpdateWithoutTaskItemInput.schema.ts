...
import { UserUpdateOneWithoutTaskItemActivitiesNestedInputObjectSchema as UserUpdateOneWithoutTaskItemActivitiesNestedInputObjectSchema } from './UserUpdateOneWithoutTaskItemActivitiesNestedInput.schema';
...
const makeSchema = () => z.object({
  ...
  actorUser: z.lazy(() => UserUpdateOneWithoutTaskItemActivitiesNestedInputObjectSchema).optional(),
  replies: z.lazy(() => TaskItemActivityReplyUpdateManyWithoutActivityNestedInputObjectSchema).optional()
}).strict();
export const TaskItemActivityUpdateWithoutTaskItemInputObjectSchema: z.ZodType<Prisma.TaskItemActivityUpdateWithoutTaskItemInput> = makeSchema() as unknown as z.ZodType<Prisma.TaskItemActivityUpdateWithoutTaskItemInput>;
export const TaskItemActivityUpdateWithoutTaskItemInputObjectZodSchema = makeSchema();
