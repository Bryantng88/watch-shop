...
import { MaintenanceRecordUpsertWithWhereUniqueWithoutProductVariantInputObjectSchema as MaintenanceRecordUpsertWithWhereUniqueWithoutProductVariantInputObjectSchema } from './MaintenanceRecordUpsertWithWhereUniqueWithoutProductVariantInput.schema';
...
import { MaintenanceRecordUpdateWithWhereUniqueWithoutProductVariantInputObjectSchema as MaintenanceRecordUpdateWithWhereUniqueWithoutProductVariantInputObjectSchema } from './MaintenanceRecordUpdateWithWhereUniqueWithoutProductVariantInput.schema';
import { MaintenanceRecordUpdateManyWithWhereWithoutProductVariantInputObjectSchema as MaintenanceRecordUpdateManyWithWhereWithoutProductVariantInputObjectSchema } from './MaintenanceRecordUpdateManyWithWhereWithoutProductVariantInput.schema';
...
const makeSchema = () => z.object({
  ...
  upsert: z.union([z.lazy(() => MaintenanceRecordUpsertWithWhereUniqueWithoutProductVariantInputObjectSchema), z.lazy(() => MaintenanceRecordUpsertWithWhereUniqueWithoutProductVariantInputObjectSchema).array()]).optional(),
  ...
  update: z.union([z.lazy(() => MaintenanceRecordUpdateWithWhereUniqueWithoutProductVariantInputObjectSchema), z.lazy(() => MaintenanceRecordUpdateWithWhereUniqueWithoutProductVariantInputObjectSchema).array()]).optional(),
  updateMany: z.union([z.lazy(() => MaintenanceRecordUpdateManyWithWhereWithoutProductVariantInputObjectSchema), z.lazy(() => MaintenanceRecordUpdateManyWithWhereWithoutProductVariantInputObjectSchema).array()]).optional(),
...
export const MaintenanceRecordUncheckedUpdateManyWithoutProductVariantNestedInputObjectSchema: z.ZodType<Prisma.MaintenanceRecordUncheckedUpdateManyWithoutProductVariantNestedInput> = makeSchema() as unknown as z.ZodType<Prisma.MaintenanceRecordUncheckedUpdateManyWithoutProductVariantNestedInput>;
export const MaintenanceRecordUncheckedUpdateManyWithoutProductVariantNestedInputObjectZodSchema = makeSchema();
