...
export const ProjectionEventDeliveryFindFirstSelectSchema: z.ZodType<Prisma.ProjectionEventDeliverySelect> = z.object({
...
export const ProjectionEventDeliveryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    idempotencyKey: z.boolean().optional(),
    businessEventLogId: z.boolean().optional(),
    eventKey: z.boolean().optional(),
...
export const ProjectionEventDeliveryFindFirstSchema: z.ZodType<Prisma.ProjectionEventDeliveryFindFirstArgs> = z.object({ select: ProjectionEventDeliveryFindFirstSelectSchema.optional(), include: ProjectionEventDeliveryIncludeObjectSchema.optional(), orderBy: z.union([ProjectionEventDeliveryOrderByWithRelationInputObjectSchema, ProjectionEventDeliveryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectionEventDeliveryWhereInputObjectSchema.optional(), cursor: ProjectionEventDeliveryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectionEventDeliveryScalarFieldEnumSchema, ProjectionEventDeliveryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProjectionEventDeliveryFindFirstArgs>;

export const ProjectionEventDeliveryFindFirstZodSchema = z.object({ select: ProjectionEventDeliveryFindFirstSelectSchema.optional(), include: ProjectionEventDeliveryIncludeObjectSchema.optional(), orderBy: z.union([ProjectionEventDeliveryOrderByWithRelationInputObjectSchema, ProjectionEventDeliveryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectionEventDeliveryWhereInputObjectSchema.optional(), cursor: ProjectionEventDeliveryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectionEventDeliveryScalarFieldEnumSchema, ProjectionEventDeliveryScalarFieldEnumSchema.array()]).optional() }).strict();