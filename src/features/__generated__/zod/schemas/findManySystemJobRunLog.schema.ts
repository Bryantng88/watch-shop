...
export const SystemJobRunLogFindManySelectSchema: z.ZodType<Prisma.SystemJobRunLogSelect> = z.object({
...
export const SystemJobRunLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    processorKey: z.boolean().optional(),
    triggerSource: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const SystemJobRunLogFindManySchema: z.ZodType<Prisma.SystemJobRunLogFindManyArgs> = z.object({ select: SystemJobRunLogFindManySelectSchema.optional(),  orderBy: z.union([SystemJobRunLogOrderByWithRelationInputObjectSchema, SystemJobRunLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: SystemJobRunLogWhereInputObjectSchema.optional(), cursor: SystemJobRunLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SystemJobRunLogScalarFieldEnumSchema, SystemJobRunLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SystemJobRunLogFindManyArgs>;

export const SystemJobRunLogFindManyZodSchema = z.object({ select: SystemJobRunLogFindManySelectSchema.optional(),  orderBy: z.union([SystemJobRunLogOrderByWithRelationInputObjectSchema, SystemJobRunLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: SystemJobRunLogWhereInputObjectSchema.optional(), cursor: SystemJobRunLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SystemJobRunLogScalarFieldEnumSchema, SystemJobRunLogScalarFieldEnumSchema.array()]).optional() }).strict();