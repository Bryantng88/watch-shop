...
export const WorkflowEventLogFindManySelectSchema: z.ZodType<Prisma.WorkflowEventLogSelect> = z.object({
...
export const WorkflowEventLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    eventKey: z.boolean().optional(),
    targetType: z.boolean().optional(),
    targetId: z.boolean().optional(),
...
export const WorkflowEventLogFindManySchema: z.ZodType<Prisma.WorkflowEventLogFindManyArgs> = z.object({ select: WorkflowEventLogFindManySelectSchema.optional(),  orderBy: z.union([WorkflowEventLogOrderByWithRelationInputObjectSchema, WorkflowEventLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowEventLogWhereInputObjectSchema.optional(), cursor: WorkflowEventLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowEventLogScalarFieldEnumSchema, WorkflowEventLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkflowEventLogFindManyArgs>;

export const WorkflowEventLogFindManyZodSchema = z.object({ select: WorkflowEventLogFindManySelectSchema.optional(),  orderBy: z.union([WorkflowEventLogOrderByWithRelationInputObjectSchema, WorkflowEventLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowEventLogWhereInputObjectSchema.optional(), cursor: WorkflowEventLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowEventLogScalarFieldEnumSchema, WorkflowEventLogScalarFieldEnumSchema.array()]).optional() }).strict();