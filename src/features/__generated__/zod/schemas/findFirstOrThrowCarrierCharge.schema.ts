...
export const CarrierChargeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CarrierChargeSelect> = z.object({
...
export const CarrierChargeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    shipmentId: z.boolean().optional(),
    kind: z.boolean().optional(),
    currency: z.boolean().optional(),
...
export const CarrierChargeFindFirstOrThrowSchema: z.ZodType<Prisma.CarrierChargeFindFirstOrThrowArgs> = z.object({ select: CarrierChargeFindFirstOrThrowSelectSchema.optional(), include: CarrierChargeIncludeObjectSchema.optional(), orderBy: z.union([CarrierChargeOrderByWithRelationInputObjectSchema, CarrierChargeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarrierChargeWhereInputObjectSchema.optional(), cursor: CarrierChargeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarrierChargeScalarFieldEnumSchema, CarrierChargeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CarrierChargeFindFirstOrThrowArgs>;

export const CarrierChargeFindFirstOrThrowZodSchema = z.object({ select: CarrierChargeFindFirstOrThrowSelectSchema.optional(), include: CarrierChargeIncludeObjectSchema.optional(), orderBy: z.union([CarrierChargeOrderByWithRelationInputObjectSchema, CarrierChargeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarrierChargeWhereInputObjectSchema.optional(), cursor: CarrierChargeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarrierChargeScalarFieldEnumSchema, CarrierChargeScalarFieldEnumSchema.array()]).optional() }).strict();