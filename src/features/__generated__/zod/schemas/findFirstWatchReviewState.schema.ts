...
export const WatchReviewStateFindFirstSelectSchema: z.ZodType<Prisma.WatchReviewStateSelect> = z.object({
...
export const WatchReviewStateFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    watchId: z.boolean().optional(),
    productId: z.boolean().optional(),
    targetType: z.boolean().optional(),
...
export const WatchReviewStateFindFirstSchema: z.ZodType<Prisma.WatchReviewStateFindFirstArgs> = z.object({ select: WatchReviewStateFindFirstSelectSchema.optional(), include: WatchReviewStateIncludeObjectSchema.optional(), orderBy: z.union([WatchReviewStateOrderByWithRelationInputObjectSchema, WatchReviewStateOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchReviewStateWhereInputObjectSchema.optional(), cursor: WatchReviewStateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchReviewStateScalarFieldEnumSchema, WatchReviewStateScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WatchReviewStateFindFirstArgs>;

export const WatchReviewStateFindFirstZodSchema = z.object({ select: WatchReviewStateFindFirstSelectSchema.optional(), include: WatchReviewStateIncludeObjectSchema.optional(), orderBy: z.union([WatchReviewStateOrderByWithRelationInputObjectSchema, WatchReviewStateOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchReviewStateWhereInputObjectSchema.optional(), cursor: WatchReviewStateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchReviewStateScalarFieldEnumSchema, WatchReviewStateScalarFieldEnumSchema.array()]).optional() }).strict();