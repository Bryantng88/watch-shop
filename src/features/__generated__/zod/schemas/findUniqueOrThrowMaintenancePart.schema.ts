...
export const MaintenancePartFindUniqueOrThrowSchema: z.ZodType<Prisma.MaintenancePartFindUniqueOrThrowArgs> = z.object({ select: MaintenancePartSelectObjectSchema.optional(), include: MaintenancePartIncludeObjectSchema.optional(), where: MaintenancePartWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.MaintenancePartFindUniqueOrThrowArgs>;

export const MaintenancePartFindUniqueOrThrowZodSchema = z.object({ select: MaintenancePartSelectObjectSchema.optional(), include: MaintenancePartIncludeObjectSchema.optional(), where: MaintenancePartWhereUniqueInputObjectSchema }).strict();