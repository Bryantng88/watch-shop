...
export const ProjectionEventDeliveryFindManySelectSchema: z.ZodType<Prisma.ProjectionEventDeliverySelect> = z.object({
...
export const ProjectionEventDeliveryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    idempotencyKey: z.boolean().optional(),
    businessEventLogId: z.boolean().optional(),
    eventKey: z.boolean().optional(),
