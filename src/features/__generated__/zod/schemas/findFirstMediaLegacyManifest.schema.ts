...
export const MediaLegacyManifestFindFirstSelectSchema: z.ZodType<Prisma.MediaLegacyManifestSelect> = z.object({
...
export const MediaLegacyManifestFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    legacyMediaAssetId: z.boolean().optional(),
    legacyKey: z.boolean().optional(),
    classification: z.boolean().optional(),
