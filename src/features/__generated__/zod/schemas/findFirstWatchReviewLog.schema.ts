...
export const WatchReviewLogFindFirstSelectSchema: z.ZodType<Prisma.WatchReviewLogSelect> = z.object({
...
export const WatchReviewLogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    reviewStateId: z.boolean().optional(),
    action: z.boolean().optional(),
    fromStatus: z.boolean().optional(),
...
export const WatchReviewLogFindFirstSchema: z.ZodType<Prisma.WatchReviewLogFindFirstArgs> = z.object({ select: WatchReviewLogFindFirstSelectSchema.optional(), include: WatchReviewLogIncludeObjectSchema.optional(), orderBy: z.union([WatchReviewLogOrderByWithRelationInputObjectSchema, WatchReviewLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchReviewLogWhereInputObjectSchema.optional(), cursor: WatchReviewLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchReviewLogScalarFieldEnumSchema, WatchReviewLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WatchReviewLogFindFirstArgs>;

export const WatchReviewLogFindFirstZodSchema = z.object({ select: WatchReviewLogFindFirstSelectSchema.optional(), include: WatchReviewLogIncludeObjectSchema.optional(), orderBy: z.union([WatchReviewLogOrderByWithRelationInputObjectSchema, WatchReviewLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: WatchReviewLogWhereInputObjectSchema.optional(), cursor: WatchReviewLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WatchReviewLogScalarFieldEnumSchema, WatchReviewLogScalarFieldEnumSchema.array()]).optional() }).strict();