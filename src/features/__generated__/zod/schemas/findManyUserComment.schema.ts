...
export const UserCommentFindManySelectSchema: z.ZodType<Prisma.UserCommentSelect> = z.object({
...
export const UserCommentFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    targetType: z.boolean().optional(),
    targetId: z.boolean().optional(),
    actorUserId: z.boolean().optional(),
...
export const UserCommentFindManySchema: z.ZodType<Prisma.UserCommentFindManyArgs> = z.object({ select: UserCommentFindManySelectSchema.optional(),  orderBy: z.union([UserCommentOrderByWithRelationInputObjectSchema, UserCommentOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserCommentWhereInputObjectSchema.optional(), cursor: UserCommentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserCommentScalarFieldEnumSchema, UserCommentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UserCommentFindManyArgs>;

export const UserCommentFindManyZodSchema = z.object({ select: UserCommentFindManySelectSchema.optional(),  orderBy: z.union([UserCommentOrderByWithRelationInputObjectSchema, UserCommentOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserCommentWhereInputObjectSchema.optional(), cursor: UserCommentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserCommentScalarFieldEnumSchema, UserCommentScalarFieldEnumSchema.array()]).optional() }).strict();