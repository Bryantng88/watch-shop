...
export const CarrierWebhookDeliveryFindFirstSelectSchema: z.ZodType<Prisma.CarrierWebhookDeliverySelect> = z.object({
...
export const CarrierWebhookDeliveryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    carrierCode: z.boolean().optional(),
    environment: z.boolean().optional(),
    externalEventId: z.boolean().optional(),
...
export const CarrierWebhookDeliveryFindFirstSchema: z.ZodType<Prisma.CarrierWebhookDeliveryFindFirstArgs> = z.object({ select: CarrierWebhookDeliveryFindFirstSelectSchema.optional(),  orderBy: z.union([CarrierWebhookDeliveryOrderByWithRelationInputObjectSchema, CarrierWebhookDeliveryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarrierWebhookDeliveryWhereInputObjectSchema.optional(), cursor: CarrierWebhookDeliveryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarrierWebhookDeliveryScalarFieldEnumSchema, CarrierWebhookDeliveryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CarrierWebhookDeliveryFindFirstArgs>;

export const CarrierWebhookDeliveryFindFirstZodSchema = z.object({ select: CarrierWebhookDeliveryFindFirstSelectSchema.optional(),  orderBy: z.union([CarrierWebhookDeliveryOrderByWithRelationInputObjectSchema, CarrierWebhookDeliveryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarrierWebhookDeliveryWhereInputObjectSchema.optional(), cursor: CarrierWebhookDeliveryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarrierWebhookDeliveryScalarFieldEnumSchema, CarrierWebhookDeliveryScalarFieldEnumSchema.array()]).optional() }).strict();