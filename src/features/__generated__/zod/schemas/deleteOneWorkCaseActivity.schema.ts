...
export const WorkCaseActivityDeleteOneSchema: z.ZodType<Prisma.WorkCaseActivityDeleteArgs> = z.object({ select: WorkCaseActivitySelectObjectSchema.optional(), include: WorkCaseActivityIncludeObjectSchema.optional(), where: WorkCaseActivityWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.WorkCaseActivityDeleteArgs>;

export const WorkCaseActivityDeleteOneZodSchema = z.object({ select: WorkCaseActivitySelectObjectSchema.optional(), include: WorkCaseActivityIncludeObjectSchema.optional(), where: WorkCaseActivityWhereUniqueInputObjectSchema }).strict();