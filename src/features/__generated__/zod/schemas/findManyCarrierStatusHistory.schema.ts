...
export const CarrierStatusHistoryFindManySelectSchema: z.ZodType<Prisma.CarrierStatusHistorySelect> = z.object({
...
export const CarrierStatusHistoryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    shipmentId: z.boolean().optional(),
    carrierCode: z.boolean().optional(),
    externalStatus: z.boolean().optional(),
...
export const CarrierStatusHistoryFindManySchema: z.ZodType<Prisma.CarrierStatusHistoryFindManyArgs> = z.object({ select: CarrierStatusHistoryFindManySelectSchema.optional(), include: CarrierStatusHistoryIncludeObjectSchema.optional(), orderBy: z.union([CarrierStatusHistoryOrderByWithRelationInputObjectSchema, CarrierStatusHistoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarrierStatusHistoryWhereInputObjectSchema.optional(), cursor: CarrierStatusHistoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarrierStatusHistoryScalarFieldEnumSchema, CarrierStatusHistoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CarrierStatusHistoryFindManyArgs>;

export const CarrierStatusHistoryFindManyZodSchema = z.object({ select: CarrierStatusHistoryFindManySelectSchema.optional(), include: CarrierStatusHistoryIncludeObjectSchema.optional(), orderBy: z.union([CarrierStatusHistoryOrderByWithRelationInputObjectSchema, CarrierStatusHistoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarrierStatusHistoryWhereInputObjectSchema.optional(), cursor: CarrierStatusHistoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarrierStatusHistoryScalarFieldEnumSchema, CarrierStatusHistoryScalarFieldEnumSchema.array()]).optional() }).strict();