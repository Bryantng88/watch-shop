...
export const ProductVariantFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProductVariantSelect> = z.object({
    ...
    saleStartsAt: z.boolean().optional(),
    saleEndsAt: z.boolean().optional(),
    ...
    PartVariantSpec: z.boolean().optional(),
