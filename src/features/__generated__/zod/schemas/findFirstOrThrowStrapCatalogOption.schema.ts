...
export const StrapCatalogOptionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StrapCatalogOptionSelect> = z.object({
...
export const StrapCatalogOptionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    kind: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const StrapCatalogOptionFindFirstOrThrowSchema: z.ZodType<Prisma.StrapCatalogOptionFindFirstOrThrowArgs> = z.object({ select: StrapCatalogOptionFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([StrapCatalogOptionOrderByWithRelationInputObjectSchema, StrapCatalogOptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: StrapCatalogOptionWhereInputObjectSchema.optional(), cursor: StrapCatalogOptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StrapCatalogOptionScalarFieldEnumSchema, StrapCatalogOptionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StrapCatalogOptionFindFirstOrThrowArgs>;

export const StrapCatalogOptionFindFirstOrThrowZodSchema = z.object({ select: StrapCatalogOptionFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([StrapCatalogOptionOrderByWithRelationInputObjectSchema, StrapCatalogOptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: StrapCatalogOptionWhereInputObjectSchema.optional(), cursor: StrapCatalogOptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StrapCatalogOptionScalarFieldEnumSchema, StrapCatalogOptionScalarFieldEnumSchema.array()]).optional() }).strict();