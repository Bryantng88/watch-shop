...
export const WorkCaseFindFirstSelectSchema: z.ZodType<Prisma.WorkCaseSelect> = z.object({
...
export const WorkCaseFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    refNo: z.boolean().optional(),
    title: z.boolean().optional(),
    description: z.boolean().optional(),
