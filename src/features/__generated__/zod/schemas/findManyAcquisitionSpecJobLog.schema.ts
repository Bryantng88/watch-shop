...
export const AcquisitionSpecJobLogFindManySelectSchema: z.ZodType<Prisma.AcquisitionSpecJobLogSelect> = z.object({
...
export const AcquisitionSpecJobLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    acquisitionSpecJobId: z.boolean().optional(),
    acquisitionItemId: z.boolean().optional(),
    acquisitionId: z.boolean().optional(),
...
export const AcquisitionSpecJobLogFindManySchema: z.ZodType<Prisma.AcquisitionSpecJobLogFindManyArgs> = z.object({ select: AcquisitionSpecJobLogFindManySelectSchema.optional(), include: AcquisitionSpecJobLogIncludeObjectSchema.optional(), orderBy: z.union([AcquisitionSpecJobLogOrderByWithRelationInputObjectSchema, AcquisitionSpecJobLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: AcquisitionSpecJobLogWhereInputObjectSchema.optional(), cursor: AcquisitionSpecJobLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AcquisitionSpecJobLogScalarFieldEnumSchema, AcquisitionSpecJobLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AcquisitionSpecJobLogFindManyArgs>;

export const AcquisitionSpecJobLogFindManyZodSchema = z.object({ select: AcquisitionSpecJobLogFindManySelectSchema.optional(), include: AcquisitionSpecJobLogIncludeObjectSchema.optional(), orderBy: z.union([AcquisitionSpecJobLogOrderByWithRelationInputObjectSchema, AcquisitionSpecJobLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: AcquisitionSpecJobLogWhereInputObjectSchema.optional(), cursor: AcquisitionSpecJobLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AcquisitionSpecJobLogScalarFieldEnumSchema, AcquisitionSpecJobLogScalarFieldEnumSchema.array()]).optional() }).strict();