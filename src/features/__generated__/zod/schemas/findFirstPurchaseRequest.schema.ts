...
export const PurchaseRequestFindFirstSelectSchema: z.ZodType<Prisma.PurchaseRequestSelect> = z.object({
    ...
    normalizedPhone: z.boolean().optional(),
    contactPreference: z.boolean().optional(),
    contactHandle: z.boolean().optional(),
...
export const PurchaseRequestFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    reference: z.boolean().optional(),
    status: z.boolean().optional(),
    outcome: z.boolean().optional(),
...
export const PurchaseRequestFindFirstSchema: z.ZodType<Prisma.PurchaseRequestFindFirstArgs> = z.object({ select: PurchaseRequestFindFirstSelectSchema.optional(), include: PurchaseRequestIncludeObjectSchema.optional(), orderBy: z.union([PurchaseRequestOrderByWithRelationInputObjectSchema, PurchaseRequestOrderByWithRelationInputObjectSchema.array()]).optional(), where: PurchaseRequestWhereInputObjectSchema.optional(), cursor: PurchaseRequestWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PurchaseRequestScalarFieldEnumSchema, PurchaseRequestScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PurchaseRequestFindFirstArgs>;

export const PurchaseRequestFindFirstZodSchema = z.object({ select: PurchaseRequestFindFirstSelectSchema.optional(), include: PurchaseRequestIncludeObjectSchema.optional(), orderBy: z.union([PurchaseRequestOrderByWithRelationInputObjectSchema, PurchaseRequestOrderByWithRelationInputObjectSchema.array()]).optional(), where: PurchaseRequestWhereInputObjectSchema.optional(), cursor: PurchaseRequestWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PurchaseRequestScalarFieldEnumSchema, PurchaseRequestScalarFieldEnumSchema.array()]).optional() }).strict();