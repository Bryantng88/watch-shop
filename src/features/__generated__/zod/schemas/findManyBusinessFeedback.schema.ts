...
export const BusinessFeedbackFindManySelectSchema: z.ZodType<Prisma.BusinessFeedbackSelect> = z.object({
...
export const BusinessFeedbackFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    targetType: z.boolean().optional(),
    targetId: z.boolean().optional(),
    eventKey: z.boolean().optional(),
