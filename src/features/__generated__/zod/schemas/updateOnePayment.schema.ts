...
export const PaymentUpdateOneSchema: z.ZodType<Prisma.PaymentUpdateArgs> = z.object({ select: PaymentSelectObjectSchema.optional(),  data: z.union([PaymentUpdateInputObjectSchema, PaymentUncheckedUpdateInputObjectSchema]), where: PaymentWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.PaymentUpdateArgs>;

export const PaymentUpdateOneZodSchema = z.object({ select: PaymentSelectObjectSchema.optional(),  data: z.union([PaymentUpdateInputObjectSchema, PaymentUncheckedUpdateInputObjectSchema]), where: PaymentWhereUniqueInputObjectSchema }).strict();