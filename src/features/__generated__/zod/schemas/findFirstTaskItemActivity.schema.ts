...
export const TaskItemActivityFindFirstSelectSchema: z.ZodType<Prisma.TaskItemActivitySelect> = z.object({
...
export const TaskItemActivityFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskItemId: z.boolean().optional(),
    sourceType: z.boolean().optional(),
    sourceId: z.boolean().optional(),
...
export const TaskItemActivityFindFirstSchema: z.ZodType<Prisma.TaskItemActivityFindFirstArgs> = z.object({ select: TaskItemActivityFindFirstSelectSchema.optional(), include: TaskItemActivityIncludeObjectSchema.optional(), orderBy: z.union([TaskItemActivityOrderByWithRelationInputObjectSchema, TaskItemActivityOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemActivityWhereInputObjectSchema.optional(), cursor: TaskItemActivityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemActivityScalarFieldEnumSchema, TaskItemActivityScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaskItemActivityFindFirstArgs>;

export const TaskItemActivityFindFirstZodSchema = z.object({ select: TaskItemActivityFindFirstSelectSchema.optional(), include: TaskItemActivityIncludeObjectSchema.optional(), orderBy: z.union([TaskItemActivityOrderByWithRelationInputObjectSchema, TaskItemActivityOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskItemActivityWhereInputObjectSchema.optional(), cursor: TaskItemActivityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskItemActivityScalarFieldEnumSchema, TaskItemActivityScalarFieldEnumSchema.array()]).optional() }).strict();