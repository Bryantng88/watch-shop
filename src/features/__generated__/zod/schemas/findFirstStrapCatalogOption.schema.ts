...
export const StrapCatalogOptionFindFirstSelectSchema: z.ZodType<Prisma.StrapCatalogOptionSelect> = z.object({
...
export const StrapCatalogOptionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    kind: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const StrapCatalogOptionFindFirstSchema: z.ZodType<Prisma.StrapCatalogOptionFindFirstArgs> = z.object({ select: StrapCatalogOptionFindFirstSelectSchema.optional(),  orderBy: z.union([StrapCatalogOptionOrderByWithRelationInputObjectSchema, StrapCatalogOptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: StrapCatalogOptionWhereInputObjectSchema.optional(), cursor: StrapCatalogOptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StrapCatalogOptionScalarFieldEnumSchema, StrapCatalogOptionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StrapCatalogOptionFindFirstArgs>;

export const StrapCatalogOptionFindFirstZodSchema = z.object({ select: StrapCatalogOptionFindFirstSelectSchema.optional(),  orderBy: z.union([StrapCatalogOptionOrderByWithRelationInputObjectSchema, StrapCatalogOptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: StrapCatalogOptionWhereInputObjectSchema.optional(), cursor: StrapCatalogOptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StrapCatalogOptionScalarFieldEnumSchema, StrapCatalogOptionScalarFieldEnumSchema.array()]).optional() }).strict();