...
export const MediaObjectFindManySelectSchema: z.ZodType<Prisma.MediaObjectSelect> = z.object({
...
export const MediaObjectFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    bucket: z.boolean().optional(),
    storageKey: z.boolean().optional(),
    originalFileName: z.boolean().optional(),
