...
export const TaskActionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TaskActionSelect> = z.object({
...
export const TaskActionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskTypeId: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const TaskActionFindFirstOrThrowSchema: z.ZodType<Prisma.TaskActionFindFirstOrThrowArgs> = z.object({ select: TaskActionFindFirstOrThrowSelectSchema.optional(), include: TaskActionIncludeObjectSchema.optional(), orderBy: z.union([TaskActionOrderByWithRelationInputObjectSchema, TaskActionOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskActionWhereInputObjectSchema.optional(), cursor: TaskActionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskActionScalarFieldEnumSchema, TaskActionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaskActionFindFirstOrThrowArgs>;

export const TaskActionFindFirstOrThrowZodSchema = z.object({ select: TaskActionFindFirstOrThrowSelectSchema.optional(), include: TaskActionIncludeObjectSchema.optional(), orderBy: z.union([TaskActionOrderByWithRelationInputObjectSchema, TaskActionOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskActionWhereInputObjectSchema.optional(), cursor: TaskActionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskActionScalarFieldEnumSchema, TaskActionScalarFieldEnumSchema.array()]).optional() }).strict();