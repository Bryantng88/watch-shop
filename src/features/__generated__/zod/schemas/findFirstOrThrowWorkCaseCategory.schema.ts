...
export const WorkCaseCategoryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.WorkCaseCategorySelect> = z.object({
...
export const WorkCaseCategoryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const WorkCaseCategoryFindFirstOrThrowSchema: z.ZodType<Prisma.WorkCaseCategoryFindFirstOrThrowArgs> = z.object({ select: WorkCaseCategoryFindFirstOrThrowSelectSchema.optional(), include: WorkCaseCategoryIncludeObjectSchema.optional(), orderBy: z.union([WorkCaseCategoryOrderByWithRelationInputObjectSchema, WorkCaseCategoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkCaseCategoryWhereInputObjectSchema.optional(), cursor: WorkCaseCategoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkCaseCategoryScalarFieldEnumSchema, WorkCaseCategoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkCaseCategoryFindFirstOrThrowArgs>;

export const WorkCaseCategoryFindFirstOrThrowZodSchema = z.object({ select: WorkCaseCategoryFindFirstOrThrowSelectSchema.optional(), include: WorkCaseCategoryIncludeObjectSchema.optional(), orderBy: z.union([WorkCaseCategoryOrderByWithRelationInputObjectSchema, WorkCaseCategoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkCaseCategoryWhereInputObjectSchema.optional(), cursor: WorkCaseCategoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkCaseCategoryScalarFieldEnumSchema, WorkCaseCategoryScalarFieldEnumSchema.array()]).optional() }).strict();