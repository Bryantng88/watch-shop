...
export const AcquisitionSpecJobLogFindFirstSelectSchema: z.ZodType<Prisma.AcquisitionSpecJobLogSelect> = z.object({
...
export const AcquisitionSpecJobLogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    acquisitionSpecJobId: z.boolean().optional(),
    acquisitionItemId: z.boolean().optional(),
    acquisitionId: z.boolean().optional(),
...
export const AcquisitionSpecJobLogFindFirstSchema: z.ZodType<Prisma.AcquisitionSpecJobLogFindFirstArgs> = z.object({ select: AcquisitionSpecJobLogFindFirstSelectSchema.optional(), include: AcquisitionSpecJobLogIncludeObjectSchema.optional(), orderBy: z.union([AcquisitionSpecJobLogOrderByWithRelationInputObjectSchema, AcquisitionSpecJobLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: AcquisitionSpecJobLogWhereInputObjectSchema.optional(), cursor: AcquisitionSpecJobLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AcquisitionSpecJobLogScalarFieldEnumSchema, AcquisitionSpecJobLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AcquisitionSpecJobLogFindFirstArgs>;

export const AcquisitionSpecJobLogFindFirstZodSchema = z.object({ select: AcquisitionSpecJobLogFindFirstSelectSchema.optional(), include: AcquisitionSpecJobLogIncludeObjectSchema.optional(), orderBy: z.union([AcquisitionSpecJobLogOrderByWithRelationInputObjectSchema, AcquisitionSpecJobLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: AcquisitionSpecJobLogWhereInputObjectSchema.optional(), cursor: AcquisitionSpecJobLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AcquisitionSpecJobLogScalarFieldEnumSchema, AcquisitionSpecJobLogScalarFieldEnumSchema.array()]).optional() }).strict();