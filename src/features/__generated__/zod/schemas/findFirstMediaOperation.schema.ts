...
export const MediaOperationFindFirstSelectSchema: z.ZodType<Prisma.MediaOperationSelect> = z.object({
...
export const MediaOperationFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    idempotencyKey: z.boolean().optional(),
    mediaObjectId: z.boolean().optional(),
    type: z.boolean().optional(),
