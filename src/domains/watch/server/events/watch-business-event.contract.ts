...
export const WATCH_BUSINESS_EVENT_DEFINITIONS: WatchBusinessEventDefinition[] = [
  ...
  {
    key: "watch.duplicate.confirmed",
    label: "Watch duplicate confirmed",
    targetType: "WATCH",
    group: "Watch",
    status: "ACTIVE",
    businessMeaning: "A duplicate Watch was quarantined and must leave active Watch read models.",
    producer: "watch-duplicate.actions",
    emitPoint: "confirmDuplicateWatchAction",
    targetIdPolicy: "watch.id",
    targetAliasPolicy: "[watch.id, productId]",
    payloadContract: "WatchDuplicateStatePayload",
    knownConsumers: ["projection", "timeline"],
    autoBindingScope: null,
  },
  {
    key: "watch.duplicate.restored",
    label: "Watch duplicate restored",
    targetType: "WATCH",
    group: "Watch",
    status: "ACTIVE",
    businessMeaning: "A quarantined Watch was restored and must return to active Watch read models.",
    producer: "watch-duplicate.actions",
    emitPoint: "restoreDuplicateWatchAction",
    targetIdPolicy: "watch.id",
    targetAliasPolicy: "[watch.id, productId]",
    payloadContract: "WatchDuplicateStatePayload",
    knownConsumers: ["projection", "timeline"],
  ...
  {
    key: "watch.inline.image.updated",
    label: "Watch inline image updated",
    targetType: "WATCH",
    group: "Watch",
    status: "ACTIVE",
    businessMeaning: "The Watch list/header INLINE thumbnail was replaced without changing Media workflow membership.",
    producer: "repair-watch-inline-media.application",
    emitPoint: "repairWatchInlineMedia",
    targetIdPolicy: "watch.id",
    targetAliasPolicy: "[watch.id, productId]",
  ...
  {
    key: "watch.storefront.visibility.changed",
    label: "Watch storefront visibility changed",
    targetType: "WATCH",
    group: "Watch",
    status: "ACTIVE",
    businessMeaning: "A Watch was explicitly shown on or hidden from the public storefront.",
    producer: "storefront-publish route",
    emitPoint: "POST /api/admin/watches/[id]/storefront-publish",
    targetIdPolicy: "watch.id",
    targetAliasPolicy: "[watch.id, productId]",
    payloadContract: "WatchStorefrontVisibilityChangedPayload",
    knownConsumers: ["timeline"],
    autoBindingScope: null,
  },
  {
    key: "watch.storefront.price_visibility.changed",
    label: "Watch storefront price visibility changed",
    targetType: "WATCH",
    group: "Watch",
    status: "ACTIVE",
    businessMeaning: "The public storefront price presentation changed between a numeric price and contact-only.",
    producer: "watch form / storefront-publish route",
    emitPoint: "submitWatchFormApplication or storefront-publish route",
    targetIdPolicy: "watch.id",
    targetAliasPolicy: "[watch.id, productId]",
    payloadContract: "WatchStorefrontPriceVisibilityChangedPayload",
    knownConsumers: ["timeline"],
    autoBindingScope: null,
  },
  {
    key: "watch.cover.photoroom.processed",
    label: "Watch Cover processed with PhotoRoom",
    targetType: "WATCH",
    group: "Watch",
    status: "ACTIVE",
    businessMeaning: "A storefront Cover preview was generated with PhotoRoom and its processing parameters were recorded for quota and media audit.",
    producer: "process-watch-cover-with-photoroom.application",
    emitPoint: "processWatchCoverWithPhotoRoomApplication",
    targetIdPolicy: "watch.id",
    targetAliasPolicy: "[watch.id, productId]",
    payloadContract: "WatchCoverPhotoRoomProcessedPayload",
    knownConsumers: ["timeline"],
    autoBindingScope: null,
  },
  {
    key: "watch.cover.local.processed",
    label: "Watch Cover processed locally",
    targetType: "WATCH",
    group: "Watch",
    status: "ACTIVE",
    businessMeaning: "A storefront Cover preview was recomposed locally with Sharp without consuming PhotoRoom quota.",
    producer: "process-watch-cover-with-photoroom.application",
    emitPoint: "recreateWatchCoverWithSharpApplication",
    targetIdPolicy: "watch.id",
    targetAliasPolicy: "[watch.id, productId]",
    payloadContract: "WatchCoverLocalProcessedPayload",
    knownConsumers: ["timeline"],
    autoBindingScope: null,
  },
  {
  ...
  {
    key: "watch.bought_back",
    label: "Watch bought back",
    targetType: "WATCH",
    group: "Watch",
    status: "ACTIVE",
    businessMeaning: "A previously sold Watch returned to inventory through buy-back or trade-in.",
    producer: "post-acquisition.application",
    emitPoint: "postAcquisitionApplication",
    targetIdPolicy: "watch.id",
    targetAliasPolicy: "[watch.id, productId, acquisitionId, sourceOrderItemId]",
    payloadContract: "WatchBoughtBackPayload",
    knownConsumers: ["notification", "projection"],
    autoBindingScope: null,
  },
  {
