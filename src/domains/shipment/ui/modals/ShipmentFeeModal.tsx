    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 px-4 py-6">
      <form onSubmit={submit} className="w-full max-w-2xl overflow-hidden rounded-[28px] bg-white shadow-2xl">
        <div className="border-b border-slate-100 px-6 py-5">
          <h2 className="text-xl font-semibold tracking-tight text-slate-950">Tạo phí ship & chuyển sang đang giao</h2>
        ...
        <div className="grid gap-5 px-6 py-5 md:grid-cols-2">
          ...
          <div>
            ...
            <Input value={form.carrier} onChange={(event) => patch({ carrier: event.target.value })} placeholder="GHN, GHTK, Viettel Post..." />
          </div>
