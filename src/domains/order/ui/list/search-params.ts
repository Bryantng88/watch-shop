import type { OrderListSort, OrderSearchInput, OrderViewKey } from "@/domains/order/server/shared";
...
const viewKeys = new Set<OrderViewKey>(["all", "web_pending", "need_action", "processing", "delivered", "completed", "cancelled"]);
const sortKeys = new Set<OrderListSort>(["updatedDesc", "updatedAsc", "createdDesc", "createdAsc"]);
