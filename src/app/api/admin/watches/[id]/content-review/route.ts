...
export async function POST(
    ...
    try {
        ...
        const state = body.action === "approve"
            ? await approveWatchReview({ productId: params.id, targetType: "CONTENT", userId })
            : await rejectWatchReview({ productId: params.id, targetType: "CONTENT", userId, note: body.note });
