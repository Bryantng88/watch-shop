...
export default async function GeneralCoordinationPage(props: PageProps) {
  const totalStartedAt = perfNow();
  const searchParams = (await props.searchParams) ?? {};

  const auth = await perfStep("coordination-general-page", "requirePermission", () =>
    requirePermission("TASK_VIEW"),
  );

  const data = await perfStep(
    "coordination-general-page",
  ...
  perfLog("coordination-general-page", "totalBeforeRender", totalStartedAt);
