...
export default async function TechnicalCoordinationPage(props: PageProps) {
  const totalStartedAt = perfNow();
  const searchParams = (await props.searchParams) ?? {};

  const auth = await perfStep("coordination-technical-page", "requirePermission", () =>
    requirePermission("TASK_VIEW"),
  );

  const data = await perfStep(
    "coordination-technical-page",
  ...
  perfLog("coordination-technical-page", "totalBeforeRender", totalStartedAt);
